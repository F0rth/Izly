...
public abstract class SyncOnSubscribe<S, T> implements Observable$OnSubscribe<T> {
    ...
    static class SubscriptionProducer<S, T> extends AtomicLong implements Observer<T>, Producer, Subscription {
    ...
    public final void call(Subscriber<? super T> subscriber) {
        try {
            Producer subscriptionProducer = new SubscriptionProducer(subscriber, this, generateState());

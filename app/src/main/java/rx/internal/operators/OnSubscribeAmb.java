...
public final class OnSubscribeAmb<T> implements Observable$OnSubscribe<T> {
    ...
    public final void call(Subscriber<? super T> subscriber) {
        ...
        final AtomicReference atomicReference = selection.choice;
        ...
        for (Observable observable : this.sources) {
            ...
            AmbSubscriber ambSubscriber2 = (AmbSubscriber) atomicReference.get();
            ...
            public void request(long j) {
                ...
                for (AmbSubscriber ambSubscriber2 : selection.ambSubscribers) {
                    if (!ambSubscriber2.isUnsubscribed()) {
                        if (atomicReference.get() == ambSubscriber2) {

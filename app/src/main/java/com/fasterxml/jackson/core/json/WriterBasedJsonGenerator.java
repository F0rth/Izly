...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    private void _writeSegmentCustom(int i) throws IOException, JsonGenerationException {
        int i2 = 0;
        int[] iArr = this._outputEscapes;
        char c = this._maximumNonEscapedChar <= 0 ? SupportMenu.USER_MASK : this._maximumNonEscapedChar;
    ...
    protected final void _verifyPrettyValueWrite(String str) throws IOException {
    ...
    protected final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr) throws IOException, JsonGenerationException {
        ...
        while (true) {
            if (i5 > i) {
                i3 = _readMore(inputStream, bArr, i5, i3, bArr.length);
                if (i3 < 3) {
                    break;
                }
                i = i3 - 3;
            ...
            i5 = i7 + 1;
            i4 += 3;
            this._outputTail = base64Variant.encodeBase64Chunk((((bArr[i6] & 255) | (b << 8)) << 8) | (bArr[i7] & 255), this._outputBuffer, this._outputTail);
            i6 = maxLineLength - 1;
            if (i6 <= 0) {
                char[] cArr = this._outputBuffer;
    ...
    protected final int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (i6 > 2) {
            ...
            i2 = i8 + 1;
            i6 -= 3;
            this._outputTail = base64Variant.encodeBase64Chunk((((bArr[i7] & 255) | (b << 8)) << 8) | (bArr[i8] & 255), this._outputBuffer, this._outputTail);
            i7 = maxLineLength - 1;
            if (i7 <= 0) {
                char[] cArr = this._outputBuffer;
    ...
    protected final void _writeBinary(Base64Variant base64Variant, byte[] bArr, int i, int i2) throws IOException, JsonGenerationException {
        ...
        while (i <= i2 - 3) {
            ...
            int i5 = i3 + 1;
            i = i5 + 1;
            this._outputTail = base64Variant.encodeBase64Chunk((((bArr[i3] & 255) | (b << 8)) << 8) | (bArr[i5] & 255), this._outputBuffer, this._outputTail);
            maxLineLength--;
            if (maxLineLength <= 0) {
                char[] cArr = this._outputBuffer;
                i3 = this._outputTail;

...
public abstract class DeserializationContext extends DatabindContext implements Serializable {
    ...
    protected String _desc(String str) {
        return str == null ? "[N/A]" : str.length() > MAX_ERROR_STR_LEN ? str.substring(0, MAX_ERROR_STR_LEN) + "]...[" + str.substring(str.length() - 500) : str;
    }
    ...
    protected String _quotedString(String str) {
        ...
        return String.format("\"%s]...[%s\"", new Object[]{str.substring(0, MAX_ERROR_STR_LEN), str.substring(str.length() - 500)});
    }

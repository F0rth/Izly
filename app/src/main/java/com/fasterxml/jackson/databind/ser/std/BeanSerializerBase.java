                        ...
                        if (generatorType != PropertyGenerator.class) {
                            ...
                            while (i != length) {
                                ...
                                if (simpleName.equals(beanPropertyWriter.getName())) {
                                    ...
                                    objectIdWriter = ObjectIdWriter.construct(beanPropertyWriter.getType(), null, new PropertyBasedObjectIdGenerator(findObjectIdInfo, beanPropertyWriter), findObjectIdInfo.getAlwaysAsId());
                                }
                            }

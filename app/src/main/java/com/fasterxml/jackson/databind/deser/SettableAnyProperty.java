...
public class SettableAnyProperty implements Serializable {
    ...
    static class AnySetterReferring extends Referring {
    ...
    protected void _throwAsIOE(Exception exception, String str, Object obj) throws IOException {
        if (exception instanceof IllegalArgumentException) {
            ...
            throw new JsonMappingException(null, append.toString(), (Throwable) exception);
            ...
            throw new JsonMappingException(null, cause.getMessage(), cause);
        }
    }

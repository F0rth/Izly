...
public class AtomicReferenceSerializer extends StdSerializer<AtomicReference<?>> implements ContextualSerializer {
    ...
    protected boolean _useStatic(com.fasterxml.jackson.databind.SerializerProvider r4, com.fasterxml.jackson.databind.BeanProperty r5, com.fasterxml.jackson.databind.JavaType r6) {
        /*
        r3 = this;
        r0 = 1;
        r1 = r6.isJavaLangObject();
    ...
    L_0x000f:
        ...
        if (r1 != 0) goto L_0x0008;
    L_0x0015:
        r1 = r4.getAnnotationIntrospector();
    ...
    L_0x0023:
        r2 = r5.getMember();
        r1 = r1.findSerializationTyping(r2);
        r2 = com.fasterxml.jackson.databind.annotation.JsonSerialize.Typing.STATIC;
        if (r1 == r2) goto L_0x0008;
    L_0x002f:
        r0 = com.fasterxml.jackson.databind.annotation.JsonSerialize.Typing.DYNAMIC;
        if (r1 == r0) goto L_0x0007;
    L_0x0033:
        r0 = com.fasterxml.jackson.databind.MapperFeature.USE_STATIC_TYPING;
        r0 = r4.isEnabled(r0);
        goto L_0x0008;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.fasterxml.jackson.databind.ser.std.AtomicReferenceSerializer._useStatic(com.fasterxml.jackson.databind.SerializerProvider, com.fasterxml.jackson.databind.BeanProperty, com.fasterxml.jackson.databind.JavaType):boolean");
    }

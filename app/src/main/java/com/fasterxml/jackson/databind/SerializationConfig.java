...
public final class SerializationConfig extends MapperConfigBase<SerializationFeature, SerializationConfig> implements Serializable {
    ...
    public final SerializationConfig with(FormatFeature formatFeature) {
    ...
    public final SerializationConfig withFeatures(FormatFeature... formatFeatureArr) {
    ...
    public final SerializationConfig withFeatures(Feature... featureArr) {
    ...
    public final SerializationConfig withPropertyInclusion(Value value) {
    ...
    @Deprecated
    public final SerializationConfig withSerializationInclusion(Include include) {
    ...
    public final SerializationConfig withVisibility(PropertyAccessor propertyAccessor, Visibility visibility) {
        return _withBase(this._base.withVisibility(propertyAccessor, visibility));
    }

    public final SerializationConfig without(FormatFeature formatFeature) {
    ...
    public final SerializationConfig withoutFeatures(FormatFeature... formatFeatureArr) {
        int i = this._formatWriteFeatures;
        int i2 = this._formatWriteFeaturesToChange;
        for (FormatFeature mask : formatFeatureArr) {
            int mask2 = mask.getMask();
    ...
    public final SerializationConfig withoutFeatures(Feature... featureArr) {
        int i = this._generatorFeatures;
        int i2 = this._generatorFeaturesToChange;
        for (Feature mask : featureArr) {
            int mask2 = mask.getMask();

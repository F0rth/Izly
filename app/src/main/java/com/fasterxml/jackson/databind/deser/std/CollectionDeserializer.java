...
public class CollectionDeserializer extends ContainerDeserializerBase<Collection<Object>> implements ContextualDeserializer {
    ...
    static final class CollectionReferring extends Referring {
    ...
    public static final class CollectionReferringAccumulator {
        ...
        public final Referring handleUnresolvedReference(UnresolvedForwardReference unresolvedForwardReference) {
    ...
    protected final Collection<Object> handleNonArray(JsonParser jsonParser, DeserializationContext deserializationContext, Collection<Object> collection) throws IOException {
        ...
        TypeDeserializer typeDeserializer = this._valueTypeDeserializer;
        try {
            obj = jsonParser.getCurrentToken() == JsonToken.VALUE_NULL ? jsonDeserializer.getNullValue(deserializationContext) : typeDeserializer == null ? jsonDeserializer.deserialize(jsonParser, deserializationContext) : jsonDeserializer.deserializeWithType(jsonParser, deserializationContext, typeDeserializer);
            collection.add(obj);
            return collection;
        } catch (Throwable e) {

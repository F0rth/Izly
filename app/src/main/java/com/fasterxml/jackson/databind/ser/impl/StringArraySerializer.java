...
public class StringArraySerializer extends ArraySerializerBase<String[]> implements ContextualSerializer {
        ...
        if (beanProperty != null) {
            ...
            if (member != null) {
                ...
                if (findContentSerializer != null) {
                    ...
                    return (serializerInstance == this._elementSerializer || findFormatFeature != this._unwrapSingle) ? new StringArraySerializer(this, beanProperty, serializerInstance, findFormatFeature) : this;
                }
            }
        }
        serializerInstance = null;
    ...
    public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
        return createSchemaNode("array", true).set(Purchase.KEY_ITEMS, createSchemaNode("string"));
    }

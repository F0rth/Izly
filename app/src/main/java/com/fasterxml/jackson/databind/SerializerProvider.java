...
public abstract class SerializerProvider extends DatabindContext {
    ...
    public boolean isUnknownTypeSerializer(JsonSerializer<?> jsonSerializer) {
        return jsonSerializer == this._unknownTypeSerializer || jsonSerializer == null || (isEnabled(SerializationFeature.FAIL_ON_EMPTY_BEANS) && jsonSerializer.getClass() == UnknownSerializer.class);
    }

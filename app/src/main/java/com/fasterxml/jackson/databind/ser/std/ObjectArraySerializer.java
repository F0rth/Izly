        ...
        if (type != null) {
            ...
            if (constructType.isArrayType()) {
                ...
                if (rawClass == Object.class) {
                    createSchemaNode.set(Purchase.KEY_ITEMS, JsonSchema.getDefaultSchemaNode());
                } else {
                    JsonSerializer findValueSerializer = serializerProvider.findValueSerializer(rawClass, this._property);
                    createSchemaNode.set(Purchase.KEY_ITEMS, findValueSerializer instanceof SchemaAware ? ((SchemaAware) findValueSerializer).getSchema(serializerProvider, null) : JsonSchema.getDefaultSchemaNode());

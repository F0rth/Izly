...
public final class StringDeserializer extends StdScalarDeserializer<String> {
    ...
    public final String deserializeWithType(JsonParser jsonParser, DeserializationContext deserializationContext, TypeDeserializer typeDeserializer) throws IOException {

...
public class MapEntrySerializer extends ContainerSerializer<Entry<?, ?>> implements ContextualSerializer {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        JsonSerializer findValueSerializer = jsonSerializer == null ? (!this._valueTypeIsStatic || this._valueType.isJavaLangObject()) ? jsonSerializer : serializerProvider.findValueSerializer(this._valueType, beanProperty) : serializerProvider.handleSecondaryContextualization(jsonSerializer, beanProperty);

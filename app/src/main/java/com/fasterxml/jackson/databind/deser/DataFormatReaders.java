...
public class DataFormatReaders {
    ...
    private Match _findFormat(AccessorForReader accessorForReader) throws IOException {
        ...
        while (i < length) {
            ...
            if (hasFormat != null && hasFormat.ordinal() >= this._minimalMatch.ordinal() && (matchStrength2 == null || matchStrength.ordinal() < hasFormat.ordinal())) {
                ...
                Object obj = matchStrength2;
            }
            Object obj2 = objectReader2;
            i++;
            matchStrength = hasFormat;
        }
        hasFormat = matchStrength;
        objectReader = matchStrength2;

...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
    ...
    public IndicatorLayout(Context context, Mode mode) {
        ...
        switch (mode) {
            case PULL_FROM_END:
                dimensionPixelSize = R.anim.slide_in_from_bottom;
                ...
                break;
            default:
                dimensionPixelSize = R.anim.slide_in_from_top;
                i = R.anim.slide_out_to_top;
                setBackgroundResource(R.drawable.indicator_bg_top);
                break;
        }
        this.mInAnim = AnimationUtils.loadAnimation(context, dimensionPixelSize);
        this.mInAnim.setAnimationListener(this);
        this.mOutAnim = AnimationUtils.loadAnimation(context, i);

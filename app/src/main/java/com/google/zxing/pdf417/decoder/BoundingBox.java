...
final class BoundingBox {
    ...
    final BoundingBox addMissingRows(int i, int i2, boolean z) throws NotFoundException {
        int y;
    ...
    final void setBottomRight(ResultPoint resultPoint) {
        this.bottomRight = resultPoint;
        calculateMinMaxValues();
    }

    final void setTopRight(ResultPoint resultPoint) {

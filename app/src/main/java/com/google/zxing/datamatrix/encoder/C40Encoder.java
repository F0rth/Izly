...
class C40Encoder implements Encoder {
    ...
    public void encode(EncoderContext encoderContext) {
        ...
        while (encoderContext.hasMoreCharacters()) {
            ...
            length = encoderContext.symbolInfo.dataCapacity - length;
            if (!encoderContext.hasMoreCharacters()) {
                ...
                encodeChar = HighLevelEncoder.lookAheadTest(encoderContext.msg, encoderContext.pos, getEncodingMode());
    ...
    void handleEOD(EncoderContext encoderContext, StringBuilder stringBuilder) {
        ...
        length2 = encoderContext.symbolInfo.dataCapacity - length2;
        if (length == 2) {
            stringBuilder.append('\u0000');

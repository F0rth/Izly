...
final class UPCEANExtension5Support {
    ...
    private static String parseExtension5String(String str) {
        ...
        int i = parseInt / 100;
        parseInt %= 100;
        return str2 + String.valueOf(i) + '.' + (parseInt < 10 ? "0" + parseInt : String.valueOf(parseInt));
    }
    ...
    final int decodeMiddle(BitArray bitArray, int[] iArr, StringBuilder stringBuilder) throws NotFoundException {
    ...
    final Result decodeRow(int i, BitArray bitArray, int[] iArr) throws NotFoundException {
        ...
        ResultPoint resultPoint = new ResultPoint(((float) (iArr[0] + iArr[1])) / 2.0f, (float) i);
        ResultPoint resultPoint2 = new ResultPoint((float) decodeMiddle, (float) i);
        ResultPoint[] resultPointArr = new ResultPoint[]{resultPoint, resultPoint2};
        Result result = new Result(stringBuilder2, null, resultPointArr, BarcodeFormat.UPC_EAN_EXTENSION);

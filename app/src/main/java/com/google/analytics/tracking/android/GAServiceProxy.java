...
class GAServiceProxy implements OnConnectedListener, OnConnectionFailedListener, ServiceProxy {
    ...
    private void sendQueue() {
        ...
        r8 = this;
        monitor-enter(r8);
        r2 = java.lang.Thread.currentThread();	 Catch:{ all -> 0x0070 }
        r3 = r8.thread;	 Catch:{ all -> 0x0070 }
        r3 = r3.getThread();	 Catch:{ all -> 0x0070 }
        r2 = r2.equals(r3);	 Catch:{ all -> 0x0070 }
        if (r2 != 0) goto L_0x0021;
    L_0x0011:
        r2 = r8.thread;	 Catch:{ all -> 0x0070 }
        r2 = r2.getQueue();	 Catch:{ all -> 0x0070 }
        r3 = new com.google.analytics.tracking.android.GAServiceProxy$2;	 Catch:{ all -> 0x0070 }
    ...
    L_0x001f:
        ...
        return;
    L_0x0021:
        r2 = r8.pendingClearHits;	 Catch:{ all -> 0x0070 }
        if (r2 == 0) goto L_0x0028;
    L_0x0025:
        r8.clearHits();	 Catch:{ all -> 0x0070 }
    L_0x0028:
        r2 = com.google.analytics.tracking.android.GAServiceProxy.AnonymousClass3.$SwitchMap$com$google$analytics$tracking$android$GAServiceProxy$ConnectState;	 Catch:{ all -> 0x0070 }
        r3 = r8.state;	 Catch:{ all -> 0x0070 }
        r3 = r3.ordinal();	 Catch:{ all -> 0x0070 }
        r2 = r2[r3];	 Catch:{ all -> 0x0070 }
        switch(r2) {
    ...
    L_0x0035:
        goto L_0x001f;
    L_0x0036:
        r2 = r8.queue;	 Catch:{ all -> 0x0070 }
        r2 = r2.isEmpty();	 Catch:{ all -> 0x0070 }
        if (r2 != 0) goto L_0x0073;
    L_0x003e:
        r2 = r8.queue;	 Catch:{ all -> 0x0070 }
        r2 = r2.poll();	 Catch:{ all -> 0x0070 }
        r0 = r2;
        r0 = (com.google.analytics.tracking.android.GAServiceProxy.HitParams) r0;	 Catch:{ all -> 0x0070 }
        r7 = r0;
        r2 = new java.lang.StringBuilder;	 Catch:{ all -> 0x0070 }
        r3 = "Sending hit to store  ";
        r2.<init>(r3);	 Catch:{ all -> 0x0070 }
        r2 = r2.append(r7);	 Catch:{ all -> 0x0070 }
        r2 = r2.toString();	 Catch:{ all -> 0x0070 }
        com.google.analytics.tracking.android.Log.v(r2);	 Catch:{ all -> 0x0070 }
        r2 = r8.store;	 Catch:{ all -> 0x0070 }
        r3 = r7.getWireFormatParams();	 Catch:{ all -> 0x0070 }
        r4 = r7.getHitTimeInMilliseconds();	 Catch:{ all -> 0x0070 }
        r6 = r7.getPath();	 Catch:{ all -> 0x0070 }
        r7 = r7.getCommands();	 Catch:{ all -> 0x0070 }
        r2.putHit(r3, r4, r6, r7);	 Catch:{ all -> 0x0070 }
        goto L_0x0036;
    L_0x0070:
        r2 = move-exception;
        monitor-exit(r8);
        throw r2;
    L_0x0073:
        r2 = r8.pendingDispatch;	 Catch:{ all -> 0x0070 }
        if (r2 == 0) goto L_0x001f;
    L_0x0077:
        r8.dispatchToStore();	 Catch:{ all -> 0x0070 }
        goto L_0x001f;
    L_0x007b:
        r2 = r8.queue;	 Catch:{ all -> 0x0070 }
        r2 = r2.isEmpty();	 Catch:{ all -> 0x0070 }
    ...
    L_0x0083:
        ...
        r2 = r2.toString();	 Catch:{ all -> 0x0070 }
        com.google.analytics.tracking.android.Log.v(r2);	 Catch:{ all -> 0x0070 }
        r2 = r8.gaInstance;	 Catch:{ all -> 0x0070 }
        r2 = r2.isDryRunEnabled();	 Catch:{ all -> 0x0070 }
        if (r2 != 0) goto L_0x00c2;
    L_0x00a7:
        r2 = r8.client;	 Catch:{ all -> 0x0070 }
        r3 = r7.getWireFormatParams();	 Catch:{ all -> 0x0070 }
        r4 = r7.getHitTimeInMilliseconds();	 Catch:{ all -> 0x0070 }
        r6 = r7.getPath();	 Catch:{ all -> 0x0070 }
        r7 = r7.getCommands();	 Catch:{ all -> 0x0070 }
        r2.sendHit(r3, r4, r6, r7);	 Catch:{ all -> 0x0070 }
    L_0x00bc:
        r2 = r8.queue;	 Catch:{ all -> 0x0070 }
        r2.poll();	 Catch:{ all -> 0x0070 }
        goto L_0x007b;
    L_0x00c2:
        ...
        goto L_0x00bc;
    L_0x00c8:
        r2 = r8.clock;	 Catch:{ all -> 0x0070 }
        r2 = r2.currentTimeMillis();	 Catch:{ all -> 0x0070 }
        r8.lastRequestTime = r2;	 Catch:{ all -> 0x0070 }
        goto L_0x001f;
    L_0x00d2:
        ...
        if (r2 != 0) goto L_0x001f;
    L_0x00df:
        r8.connectToService();	 Catch:{ all -> 0x0070 }
        goto L_0x001f;
        */

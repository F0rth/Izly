...
public interface Debug {
    ...
    public static final class DataLayerEventEvaluationInfo extends ExtendableMessageNano {
        ...
        public final int hashCode() {
            ...
            if (this.results == null) {
                ...
                while (i2 < this.results.length) {
                    int hashCode2 = this.results[i2] == null ? 0 : this.results[i2].hashCode();
                    i2++;
        ...
        public final DataLayerEventEvaluationInfo mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                switch (readTag) {
                    ...
                    case 18:
                        ...
                        readTag = this.results == null ? 0 : this.results.length;
    ...
    public static final class DebugEvents extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.event != null) {
                ...
                while (i2 < eventInfoArr.length) {
                    i2++;
                    i += CodedOutputByteBufferNano.computeMessageSize(1, eventInfoArr[i2]);
                }
            }
        ...
        public final int hashCode() {
            ...
            if (this.event == null) {
                ...
                i = 17;
                int i3 = 0;
                while (i3 < this.event.length) {
                    i3++;
                    i = (this.event[i3] == null ? 0 : this.event[i3].hashCode()) + (i * 31);
                }
            }
            if (this.unknownFieldData != null) {
        ...
        public final DebugEvents mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
                    ...
                    case 10:
                        ...
                        readTag = this.event == null ? 0 : this.event.length;
    ...
    public static final class EventInfo extends ExtendableMessageNano {
        ...
        public final int hashCode() {
            ...
            int hashCode = this.containerVersion == null ? 0 : this.containerVersion.hashCode();
            int hashCode2 = this.containerId == null ? 0 : this.containerId.hashCode();
            int hashCode3 = this.key == null ? 0 : this.key.hashCode();
            int hashCode4 = this.macroResult == null ? 0 : this.macroResult.hashCode();
            int hashCode5 = this.dataLayerEventResult == null ? 0 : this.dataLayerEventResult.hashCode();
            if (this.unknownFieldData != null) {
                i = this.unknownFieldData.hashCode();
            }
            return ((((((((((hashCode + ((i2 + 527) * 31)) * 31) + hashCode2) * 31) + hashCode3) * 31) + hashCode4) * 31) + hashCode5) * 31) + i;
        }

        public final EventInfo mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
    ...
    public static final class MacroEvaluationInfo extends ExtendableMessageNano {
        ...
        public final int hashCode() {
            int i = 0;
            int hashCode = this.rulesEvaluation == null ? 0 : this.rulesEvaluation.hashCode();
            int hashCode2 = this.result == null ? 0 : this.result.hashCode();
            if (this.unknownFieldData != null) {
                i = this.unknownFieldData.hashCode();
            }
        ...
        public final MacroEvaluationInfo mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
    ...
    public static final class ResolvedFunctionCall extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.properties != null) {
                ...
                while (i2 < resolvedPropertyArr.length) {
                    i2++;
                    i += CodedOutputByteBufferNano.computeMessageSize(1, resolvedPropertyArr[i2]);
                }
            }
            if (this.result != null) {
        ...
        public final int hashCode() {
            ...
            i2 = this.result == null ? 0 : this.result.hashCode();
            int hashCode = this.associatedRuleName == null ? 0 : this.associatedRuleName.hashCode();
            if (this.unknownFieldData != null) {
        ...
        public final ResolvedFunctionCall mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
                    ...
                    case 10:
                        int repeatedFieldArrayLength = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 10);
                        readTag = this.properties == null ? 0 : this.properties.length;
    ...
    public static final class ResolvedProperty extends ExtendableMessageNano {
        ...
        public final ResolvedProperty mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
    ...
    public static final class ResolvedRule extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.positivePredicates != null) {
                ...
                while (i < resolvedFunctionCallArr.length) {
                    i++;
                    i2 += CodedOutputByteBufferNano.computeMessageSize(1, resolvedFunctionCallArr[i]);
                }
            } else {
                i2 = 0;
            }
            if (this.negativePredicates != null) {
                ...
                while (i < resolvedFunctionCallArr.length) {
                    i++;
                    i2 += CodedOutputByteBufferNano.computeMessageSize(2, resolvedFunctionCallArr[i]);
                }
            }
            if (this.addTags != null) {
                ...
                while (i < resolvedFunctionCallArr.length) {
                    i++;
                    i2 += CodedOutputByteBufferNano.computeMessageSize(3, resolvedFunctionCallArr[i]);
                }
            }
            if (this.removeTags != null) {
                ...
                while (i < resolvedFunctionCallArr.length) {
                    i++;
                    i2 += CodedOutputByteBufferNano.computeMessageSize(4, resolvedFunctionCallArr[i]);
                }
            }
            if (this.addMacros != null) {
                ...
                while (i < resolvedFunctionCallArr.length) {
                    i++;
                    i2 += CodedOutputByteBufferNano.computeMessageSize(5, resolvedFunctionCallArr[i]);
                }
            }
        ...
        public final int hashCode() {
            ...
            if (this.negativePredicates == null) {
                ...
                i2 = 0;
                while (i2 < this.negativePredicates.length) {
                    int hashCode = this.negativePredicates[i2] == null ? 0 : this.negativePredicates[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.addTags == null) {
                ...
                i2 = 0;
                while (i2 < this.addTags.length) {
                    hashCode = this.addTags[i2] == null ? 0 : this.addTags[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.removeTags == null) {
                ...
                i2 = 0;
                while (i2 < this.removeTags.length) {
                    hashCode = this.removeTags[i2] == null ? 0 : this.removeTags[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.addMacros == null) {
                ...
                i2 = 0;
                while (i2 < this.addMacros.length) {
                    hashCode = this.addMacros[i2] == null ? 0 : this.addMacros[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.removeMacros == null) {
                ...
                i2 = 0;
                while (i2 < this.removeMacros.length) {
                    hashCode = this.removeMacros[i2] == null ? 0 : this.removeMacros[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
        ...
        public final ResolvedRule mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                ...
                switch (readTag) {
                    ...
                    case 10:
                        ...
                        readTag = this.positivePredicates == null ? 0 : this.positivePredicates.length;
                    ...
                    case 18:
                        ...
                        readTag = this.negativePredicates == null ? 0 : this.negativePredicates.length;
                        obj = new ResolvedFunctionCall[(repeatedFieldArrayLength + readTag)];
                        if (this.negativePredicates != null) {
                    ...
                    case 26:
                        ...
                        readTag = this.addTags == null ? 0 : this.addTags.length;
                        obj = new ResolvedFunctionCall[(repeatedFieldArrayLength + readTag)];
                        if (this.addTags != null) {
                    ...
                    case 34:
                        ...
                        readTag = this.removeTags == null ? 0 : this.removeTags.length;
                        obj = new ResolvedFunctionCall[(repeatedFieldArrayLength + readTag)];
                        if (this.removeTags != null) {
                    ...
                    case 42:
                        ...
                        readTag = this.addMacros == null ? 0 : this.addMacros.length;
                        obj = new ResolvedFunctionCall[(repeatedFieldArrayLength + readTag)];
                        if (this.addMacros != null) {
                    ...
                    case 50:
                        ...
                        readTag = this.removeMacros == null ? 0 : this.removeMacros.length;
                        obj = new ResolvedFunctionCall[(repeatedFieldArrayLength + readTag)];
                        if (this.removeMacros != null) {
    ...
    public static final class RuleEvaluationStepInfo extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.rules != null) {
                ...
                while (i3 < resolvedRuleArr.length) {
                    i3++;
                    i += CodedOutputByteBufferNano.computeMessageSize(1, resolvedRuleArr[i3]);
                }
            } else {
                i = 0;
            }
        ...
        public final int hashCode() {
            ...
            if (this.enabledFunctions == null) {
                ...
                i2 = 0;
                while (i2 < this.enabledFunctions.length) {
                    int hashCode = this.enabledFunctions[i2] == null ? 0 : this.enabledFunctions[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
        ...
        public final RuleEvaluationStepInfo mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                int repeatedFieldArrayLength;
                Object obj;
                switch (readTag) {
                    ...
                    case 10:
                        repeatedFieldArrayLength = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 10);
                        readTag = this.rules == null ? 0 : this.rules.length;
                    ...
                    case 18:
                        repeatedFieldArrayLength = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 18);
                        readTag = this.enabledFunctions == null ? 0 : this.enabledFunctions.length;
                        obj = new ResolvedFunctionCall[(repeatedFieldArrayLength + readTag)];
                        if (this.enabledFunctions != null) {

...
public interface Serving {
    ...
    public static final class CacheOption extends ExtendableMessageNano {
        ...
        public final int hashCode() {
            ...
            return (this.unknownFieldData == null ? 0 : this.unknownFieldData.hashCode()) + ((((((i + 527) * 31) + i2) * 31) + this.gcacheExpirationSeconds) * 31);
        }

        public final CacheOption mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
    ...
    public static final class Container extends ExtendableMessageNano {
        ...
        public final int hashCode() {
            int i = 0;
            int hashCode = this.jsResource == null ? 0 : this.jsResource.hashCode();
            int hashCode2 = this.containerId == null ? 0 : this.containerId.hashCode();
            int i2 = this.state;
            int hashCode3 = this.version == null ? 0 : this.version.hashCode();
            if (this.unknownFieldData != null) {
                i = this.unknownFieldData.hashCode();
            }
            return ((((((((hashCode + 527) * 31) + hashCode2) * 31) + i2) * 31) + hashCode3) * 31) + i;
        }

        public final Container mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
    ...
    public static final class FunctionCall extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            int i = 0;
            int computeBoolSize = (this.serverSide ? CodedOutputByteBufferNano.computeBoolSize(1, this.serverSide) + 0 : 0) + CodedOutputByteBufferNano.computeInt32Size(2, this.function);
            if (this.property != null && this.property.length > 0) {
                for (int computeInt32SizeNoTag : this.property) {
        ...
        public final int hashCode() {
            ...
            if (this.property == null) {
                ...
                i = 17;
                i2 = 0;
                while (i2 < this.property.length) {
                    i3 = this.property[i2] + (i * 31);
                    i2++;
                    i = i3;
                }
            }
            i3 = this.function;
            int i5 = this.name;
            i2 = this.liveOnly ? 1 : 2;
            if (!this.serverSide) {
                i4 = 2;
            }
            return (((((((((i * 31) + i3) * 31) + i5) * 31) + i2) * 31) + i4) * 31) + (this.unknownFieldData == null ? 0 : this.unknownFieldData.hashCode());
        }

        public final FunctionCall mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
    ...
    public static final class GaExperimentRandom extends ExtendableMessageNano {
        ...
        public final int hashCode() {
            ...
            int i2 = (int) (this.minRandom ^ (this.minRandom >>> 32));
            int i3 = (int) (this.maxRandom ^ (this.maxRandom >>> 32));
            int i4 = this.retainOriginalValue ? 1 : 2;
            int i5 = (int) (this.lifetimeInMilliseconds ^ (this.lifetimeInMilliseconds >>> 32));
            if (this.unknownFieldData != null) {
                i = this.unknownFieldData.hashCode();
            }
            return ((((((((((hashCode + 527) * 31) + i2) * 31) + i3) * 31) + i4) * 31) + i5) * 31) + i;
        }

        public final GaExperimentRandom mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
    ...
    public static final class GaExperimentSupplemental extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.valueToPush != null) {
                ...
                while (i < valueArr.length) {
                    i++;
                    i2 += CodedOutputByteBufferNano.computeMessageSize(1, valueArr[i]);
                }
            } else {
                i2 = 0;
            }
            if (this.valueToClear != null) {
                ...
                while (i < valueArr.length) {
                    i++;
                    i2 += CodedOutputByteBufferNano.computeMessageSize(2, valueArr[i]);
                }
            }
        ...
        public final int hashCode() {
            ...
            if (this.valueToPush == null) {
                ...
                i = 17;
                i2 = 0;
                while (i2 < this.valueToPush.length) {
                    i2++;
            ...
            if (this.valueToClear == null) {
                ...
                i2 = 0;
                while (i2 < this.valueToClear.length) {
                    int hashCode = this.valueToClear[i2] == null ? 0 : this.valueToClear[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.experimentRandom == null) {
                ...
                i2 = 0;
                while (i2 < this.experimentRandom.length) {
                    hashCode = this.experimentRandom[i2] == null ? 0 : this.experimentRandom[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
        ...
        public final GaExperimentSupplemental mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                ...
                switch (readTag) {
                    ...
                    case 10:
                        ...
                        readTag = this.valueToPush == null ? 0 : this.valueToPush.length;
                    ...
                    case 18:
                        ...
                        readTag = this.valueToClear == null ? 0 : this.valueToClear.length;
                        obj = new Value[(repeatedFieldArrayLength + readTag)];
                        if (this.valueToClear != null) {
                    ...
                    case 26:
                        ...
                        readTag = this.experimentRandom == null ? 0 : this.experimentRandom.length;
    ...
    public static final class Property extends ExtendableMessageNano {
        ...
        public final int hashCode() {
            int i = this.key;
            return (this.unknownFieldData == null ? 0 : this.unknownFieldData.hashCode()) + ((((i + 527) * 31) + this.value) * 31);
        }

        public final Property mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
    ...
    public static final class Resource extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.key == null || this.key.length <= 0) {
                ...
                for (String computeStringSizeNoTag : this.key) {
                    i += CodedOutputByteBufferNano.computeStringSizeNoTag(computeStringSizeNoTag);
                }
                i = (i + 0) + (this.key.length * 1);
            }
            if (this.value != null) {
                ...
                while (i2 < valueArr.length) {
                    i2++;
                    i += CodedOutputByteBufferNano.computeMessageSize(2, valueArr[i2]);
                }
            }
            if (this.property != null) {
                ...
                while (i2 < propertyArr.length) {
                    i2++;
                    i += CodedOutputByteBufferNano.computeMessageSize(3, propertyArr[i2]);
                }
            }
            if (this.macro != null) {
                ...
                while (i2 < functionCallArr.length) {
                    i2++;
                    i += CodedOutputByteBufferNano.computeMessageSize(4, functionCallArr[i2]);
                }
            }
            if (this.tag != null) {
                ...
                while (i2 < functionCallArr.length) {
                    i2++;
                    i += CodedOutputByteBufferNano.computeMessageSize(5, functionCallArr[i2]);
                }
            }
            if (this.predicate != null) {
                ...
                while (i2 < functionCallArr.length) {
                    i2++;
                    i += CodedOutputByteBufferNano.computeMessageSize(6, functionCallArr[i2]);
                }
            }
            if (this.rule != null) {
                ...
                while (i2 < ruleArr.length) {
                    i2++;
                    i += CodedOutputByteBufferNano.computeMessageSize(7, ruleArr[i2]);
                }
            }
            ...
            if (this.usageContext != null && this.usageContext.length > 0) {
                ...
                for (String computeStringSizeNoTag2 : this.usageContext) {
                    i2 += CodedOutputByteBufferNano.computeStringSizeNoTag(computeStringSizeNoTag2);
                }
                i = (i + i2) + (this.usageContext.length * 2);
            }
            ...
            if (this.supplemental != null && this.supplemental.length > 0) {
                for (String computeStringSizeNoTag3 : this.supplemental) {
                    i3 += CodedOutputByteBufferNano.computeStringSizeNoTag(computeStringSizeNoTag3);
                }
                i = (i + i3) + (this.supplemental.length * 2);
            }
            i += WireFormatNano.computeWireSize(this.unknownFieldData);
            this.cachedSize = i;
            return i;
        ...
        public final int hashCode() {
            ...
            if (this.supplemental == null) {
                ...
                i = 17;
                i2 = 0;
                while (i2 < this.supplemental.length) {
                    i2++;
            ...
            if (this.key == null) {
                ...
                while (i2 < this.key.length) {
                    hashCode = this.key[i2] == null ? 0 : this.key[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.value == null) {
                ...
                while (i2 < this.value.length) {
                    hashCode = this.value[i2] == null ? 0 : this.value[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.property == null) {
                ...
                i2 = 0;
                while (i2 < this.property.length) {
                    hashCode = this.property[i2] == null ? 0 : this.property[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.macro == null) {
                ...
                i2 = 0;
                while (i2 < this.macro.length) {
                    hashCode = this.macro[i2] == null ? 0 : this.macro[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.tag == null) {
                ...
                i2 = 0;
                while (i2 < this.tag.length) {
                    hashCode = this.tag[i2] == null ? 0 : this.tag[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.predicate == null) {
                ...
                i2 = 0;
                while (i2 < this.predicate.length) {
                    hashCode = this.predicate[i2] == null ? 0 : this.predicate[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            if (this.rule == null) {
                ...
                i2 = 0;
                while (i2 < this.rule.length) {
                    hashCode = this.rule[i2] == null ? 0 : this.rule[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            i2 = this.previewAuthCode == null ? 0 : this.previewAuthCode.hashCode();
            hashCode = this.malwareScanAuthCode == null ? 0 : this.malwareScanAuthCode.hashCode();
            int hashCode2 = this.templateVersionSet == null ? 0 : this.templateVersionSet.hashCode();
            int hashCode3 = this.version == null ? 0 : this.version.hashCode();
            i = (((((((((((((i * 31) + i2) * 31) + hashCode) * 31) + hashCode2) * 31) + hashCode3) * 31) + (this.liveJsCacheOption == null ? 0 : this.liveJsCacheOption.hashCode())) * 31) + Float.floatToIntBits(this.reportingSampleRate)) * 31) + (this.oBSOLETEEnableAutoEventTracking ? 1 : 2);
            if (this.usageContext == null) {
                i *= 31;
            } else {
                i2 = 0;
                while (i2 < this.usageContext.length) {
                    hashCode = this.usageContext[i2] == null ? 0 : this.usageContext[i2].hashCode();
                    i2++;
                    i = hashCode + (i * 31);
                }
            }
            i2 = this.resourceFormatVersion;
            if (this.unknownFieldData != null) {
                i3 = this.unknownFieldData.hashCode();
            }
        ...
        public final Resource mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                int repeatedFieldArrayLength;
                Object obj;
                switch (readTag) {
                    ...
                    case 18:
                        repeatedFieldArrayLength = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 18);
                        readTag = this.value == null ? 0 : this.value.length;
                        obj = new Value[(repeatedFieldArrayLength + readTag)];
                        if (this.value != null) {
                    ...
                    case 26:
                        repeatedFieldArrayLength = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 26);
                        readTag = this.property == null ? 0 : this.property.length;
                    ...
                    case 34:
                        ...
                        readTag = this.macro == null ? 0 : this.macro.length;
                    ...
                    case 42:
                        ...
                        readTag = this.tag == null ? 0 : this.tag.length;
                        obj = new FunctionCall[(repeatedFieldArrayLength + readTag)];
                        if (this.tag != null) {
                    ...
                    case 50:
                        ...
                        readTag = this.predicate == null ? 0 : this.predicate.length;
                        obj = new FunctionCall[(repeatedFieldArrayLength + readTag)];
                        if (this.predicate != null) {
                    ...
                    case 58:
                        ...
                        readTag = this.rule == null ? 0 : this.rule.length;
                    ...
                    case TransportMediator.KEYCODE_MEDIA_RECORD /*130*/:
                        repeatedFieldArrayLength = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, TransportMediator.KEYCODE_MEDIA_RECORD);
    ...
    public static final class Rule extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.positivePredicate == null || this.positivePredicate.length <= 0) {
                ...
                i = (i + 0) + (this.positivePredicate.length * 1);
            }
            if (this.negativePredicate != null && this.negativePredicate.length > 0) {
                ...
                i = (i + i2) + (this.negativePredicate.length * 1);
            }
            if (this.addTag != null && this.addTag.length > 0) {
                i2 = 0;
                for (int computeInt32SizeNoTag22 : this.addTag) {
                    i2 += CodedOutputByteBufferNano.computeInt32SizeNoTag(computeInt32SizeNoTag22);
                }
                i = (i + i2) + (this.addTag.length * 1);
            }
            if (this.removeTag != null && this.removeTag.length > 0) {
                i2 = 0;
                for (int computeInt32SizeNoTag222 : this.removeTag) {
                    i2 += CodedOutputByteBufferNano.computeInt32SizeNoTag(computeInt32SizeNoTag222);
                }
                i = (i + i2) + (this.removeTag.length * 1);
            }
            if (this.addTagRuleName != null && this.addTagRuleName.length > 0) {
                i2 = 0;
                for (int computeInt32SizeNoTag2222 : this.addTagRuleName) {
                    i2 += CodedOutputByteBufferNano.computeInt32SizeNoTag(computeInt32SizeNoTag2222);
                }
                i = (i + i2) + (this.addTagRuleName.length * 1);
            }
            if (this.removeTagRuleName != null && this.removeTagRuleName.length > 0) {
                i2 = 0;
                for (int computeInt32SizeNoTag22222 : this.removeTagRuleName) {
                    i2 += CodedOutputByteBufferNano.computeInt32SizeNoTag(computeInt32SizeNoTag22222);
                }
                i = (i + i2) + (this.removeTagRuleName.length * 1);
            }
            if (this.addMacro != null && this.addMacro.length > 0) {
                i2 = 0;
                for (int computeInt32SizeNoTag222222 : this.addMacro) {
                    i2 += CodedOutputByteBufferNano.computeInt32SizeNoTag(computeInt32SizeNoTag222222);
                }
                i = (i + i2) + (this.addMacro.length * 1);
            }
            if (this.removeMacro != null && this.removeMacro.length > 0) {
                i2 = 0;
                for (int computeInt32SizeNoTag2222222 : this.removeMacro) {
                    i2 += CodedOutputByteBufferNano.computeInt32SizeNoTag(computeInt32SizeNoTag2222222);
                }
                i = (i + i2) + (this.removeMacro.length * 1);
            }
            if (this.addMacroRuleName != null && this.addMacroRuleName.length > 0) {
                i2 = 0;
                for (int computeInt32SizeNoTag22222222 : this.addMacroRuleName) {
                    i2 += CodedOutputByteBufferNano.computeInt32SizeNoTag(computeInt32SizeNoTag22222222);
                }
                i = (i + i2) + (this.addMacroRuleName.length * 1);
            }
            if (this.removeMacroRuleName != null && this.removeMacroRuleName.length > 0) {
                for (int computeInt32SizeNoTag3 : this.removeMacroRuleName) {
                    i3 += CodedOutputByteBufferNano.computeInt32SizeNoTag(computeInt32SizeNoTag3);
                }
                i = (i + i3) + (this.removeMacroRuleName.length * 1);
            }
            i += WireFormatNano.computeWireSize(this.unknownFieldData);
            this.cachedSize = i;
            return i;
        ...
        public final int hashCode() {
            ...
            if (this.positivePredicate == null) {
                ...
                i = 17;
                i2 = 0;
                while (i2 < this.positivePredicate.length) {
                    int i4 = this.positivePredicate[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
            if (this.negativePredicate == null) {
                ...
                i2 = 0;
                while (i2 < this.negativePredicate.length) {
                    i4 = this.negativePredicate[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
            if (this.addTag == null) {
                ...
                i2 = 0;
                while (i2 < this.addTag.length) {
                    i4 = this.addTag[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
            if (this.removeTag == null) {
                ...
                i2 = 0;
                while (i2 < this.removeTag.length) {
                    i4 = this.removeTag[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
            if (this.addTagRuleName == null) {
                ...
                i2 = 0;
                while (i2 < this.addTagRuleName.length) {
                    i4 = this.addTagRuleName[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
            if (this.removeTagRuleName == null) {
                ...
                i2 = 0;
                while (i2 < this.removeTagRuleName.length) {
                    i4 = this.removeTagRuleName[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
            if (this.addMacro == null) {
                ...
                i2 = 0;
                while (i2 < this.addMacro.length) {
                    i4 = this.addMacro[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
            if (this.removeMacro == null) {
                ...
                i2 = 0;
                while (i2 < this.removeMacro.length) {
                    i4 = this.removeMacro[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
            if (this.addMacroRuleName == null) {
                ...
                i2 = 0;
                while (i2 < this.addMacroRuleName.length) {
                    i4 = this.addMacroRuleName[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
            if (this.removeMacroRuleName == null) {
                ...
                i2 = 0;
                while (i2 < this.removeMacroRuleName.length) {
                    i4 = this.removeMacroRuleName[i2] + (i * 31);
                    i2++;
                    i = i4;
                }
            }
        ...
        public final Rule mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                int repeatedFieldArrayLength;
                Object obj;
    ...
    public static final class ServingValue extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.templateToken != null && this.templateToken.length > 0) {
                for (int computeInt32SizeNoTag3 : this.templateToken) {
                    i3 += CodedOutputByteBufferNano.computeInt32SizeNoTag(computeInt32SizeNoTag3);
                }
                i = (i + i3) + (this.templateToken.length * 1);
            }
        ...
        public final int hashCode() {
            ...
            if (this.mapKey == null) {
                ...
                i2 = 0;
                while (i2 < this.mapKey.length) {
                    i3 = this.mapKey[i2] + (i * 31);
                    i2++;
                    i = i3;
                }
            }
            if (this.mapValue == null) {
                ...
                i2 = 0;
                while (i2 < this.mapValue.length) {
                    i3 = this.mapValue[i2] + (i * 31);
                    i2++;
                    i = i3;
                }
            }
            ...
            if (this.templateToken == null) {
                ...
                i2 = 0;
                while (i2 < this.templateToken.length) {
                    i3 = this.templateToken[i2] + (i * 31);
                    i2++;
                    i = i3;
                }
            }
            i2 = this.macroNameReference;
            i3 = this.tagReference;
            if (this.unknownFieldData != null) {
        ...
        public final ServingValue mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                int repeatedFieldArrayLength;
                Object obj;
    ...
    public static final class Supplemental extends ExtendableMessageNano {
        ...
        public final int hashCode() {
            ...
            int hashCode3 = this.experimentSupplemental == null ? 0 : this.experimentSupplemental.hashCode();
            if (this.unknownFieldData != null) {
                i = this.unknownFieldData.hashCode();
            }
        ...
        public final Supplemental mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
    ...
    public static final class SupplementedResource extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.supplemental != null) {
                ...
                while (i2 < supplementalArr.length) {
                    i2++;
                    i += CodedOutputByteBufferNano.computeMessageSize(1, supplementalArr[i2]);
                }
            }
        ...
        public final int hashCode() {
            ...
            i2 = this.resource == null ? 0 : this.resource.hashCode();
            int hashCode = this.fingerprint == null ? 0 : this.fingerprint.hashCode();
            if (this.unknownFieldData != null) {
                i3 = this.unknownFieldData.hashCode();
            }
        ...
        public final SupplementedResource mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                int readTag = codedInputByteBufferNano.readTag();
                switch (readTag) {
                    case 0:
                    ...
                    case 10:
                        ...
                        readTag = this.supplemental == null ? 0 : this.supplemental.length;

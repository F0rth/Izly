...
public interface TypeSystem {
    ...
    public static final class Value extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            ...
            if (this.listItem != null) {
                ...
                while (i < valueArr.length) {
                    i++;
                    computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(3, valueArr[i]);
                }
            }
            if (this.mapKey != null) {
                ...
                while (i < valueArr.length) {
                    i++;
                    computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(4, valueArr[i]);
                }
            }
            if (this.mapValue != null) {
                ...
                while (i < valueArr.length) {
                    i++;
                    computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(5, valueArr[i]);
                }
            }
            ...
            if (this.templateToken != null) {
                ...
                while (i2 < valueArr2.length) {
                    i2++;
                    computeInt32Size += CodedOutputByteBufferNano.computeMessageSize(11, valueArr2[i2]);
                }
            }
            if (this.boolean_) {
        ...
        public final int hashCode() {
            ...
            if (this.listItem == null) {
                ...
                while (i < this.listItem.length) {
                    int hashCode2 = this.listItem[i] == null ? 0 : this.listItem[i].hashCode();
                    i++;
            ...
            if (this.mapKey == null) {
                ...
                i = 0;
                while (i < this.mapKey.length) {
                    hashCode2 = this.mapKey[i] == null ? 0 : this.mapKey[i].hashCode();
                    i++;
                    hashCode = hashCode2 + (hashCode * 31);
                }
            }
            if (this.mapValue == null) {
                ...
                i = 0;
                while (i < this.mapValue.length) {
                    hashCode2 = this.mapValue[i] == null ? 0 : this.mapValue[i].hashCode();
                    i++;
                    hashCode = hashCode2 + (hashCode * 31);
                }
            }
            hashCode = (((((((hashCode * 31) + (this.macroReference == null ? 0 : this.macroReference.hashCode())) * 31) + (this.functionId == null ? 0 : this.functionId.hashCode())) * 31) + ((int) (this.integer ^ (this.integer >>> 32)))) * 31) + (this.boolean_ ? 1 : 2);
            if (this.templateToken == null) {
                hashCode *= 31;
            } else {
                i = 0;
                while (i < this.templateToken.length) {
                    hashCode2 = this.templateToken[i] == null ? 0 : this.templateToken[i].hashCode();
                    i++;
                    hashCode = hashCode2 + (hashCode * 31);
                }
            }
            hashCode = (hashCode * 31) + (this.tagReference == null ? 0 : this.tagReference.hashCode());
            if (this.escaping == null) {
                hashCode *= 31;
            } else {
                i = 0;
                while (i < this.escaping.length) {
                    hashCode2 = this.escaping[i] + (hashCode * 31);
                    i++;
                    hashCode = hashCode2;
                }
            }
        ...
        public final Value mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {
                ...
                switch (readTag) {
                    ...
                    case 26:
                        ...
                        readTag = this.listItem == null ? 0 : this.listItem.length;
                    ...
                    case 34:
                        ...
                        readTag = this.mapKey == null ? 0 : this.mapKey.length;
                        obj = new Value[(repeatedFieldArrayLength + readTag)];
                        if (this.mapKey != null) {
                    ...
                    case 42:
                        ...
                        readTag = this.mapValue == null ? 0 : this.mapValue.length;
                        obj = new Value[(repeatedFieldArrayLength + readTag)];
                        if (this.mapValue != null) {
                    ...
                    case 90:
                        ...
                        readTag = this.templateToken == null ? 0 : this.templateToken.length;
                        obj = new Value[(repeatedFieldArrayLength + readTag)];
                        if (this.templateToken != null) {

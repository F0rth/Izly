...
public class zzjq extends WebViewClient {
    private static final String[] zzNy = new String[]{"UNKNOWN", "HOST_LOOKUP", "UNSUPPORTED_AUTH_SCHEME", "AUTHENTICATION", "PROXY_AUTHENTICATION", "CONNECT", "IO", InstanceID.ERROR_TIMEOUT, "REDIRECT_LOOP", "UNSUPPORTED_SCHEME", "FAILED_SSL_HANDSHAKE", "BAD_URL", "FILE", "FILE_NOT_FOUND", "TOO_MANY_REQUESTS"};
    ...
    static class zzc implements zzg {
        private zzg zzNB;
        private zzjp zzNM;
    ...
    public final void onReceivedError(WebView webView, int i, String str, String str2) {
        String valueOf = (i >= 0 || (-i) - 1 >= zzNy.length) ? String.valueOf(i) : zzNy[(-i) - 1];
        zza(this.zzpD.getContext(), "http_err", valueOf, str2);
    ...
    public final void onReceivedSslError(WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
        if (sslError != null) {
            ...
            zza(this.zzpD.getContext(), "ssl_err", valueOf, zzr.zzbE().zza(sslError));
        }
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        if ("gmsg".equalsIgnoreCase(parse.getScheme()) && "mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.zzaK("AdWebView unable to handle URL: " + str);
        } else {
            Uri uri;
            try {
                ...
                if (zzhW == null || !zzhW.zzb(parse)) {
                    ...
                    uri = zzhW.zza(parse, this.zzpD.getContext());
                    if (this.zzzA != null) {
                    }
                    zza(new AdLauncherIntentInfoParcel("android.intent.action.VIEW", uri.toString(), null, null, null, null, null));
                }
            } catch (zzao e) {
                com.google.android.gms.ads.internal.util.client.zzb.zzaK("Unable to append parameter to URL: " + str);
                uri = parse;
            }
        }
        return true;

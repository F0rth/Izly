...
public class zzfn extends zzfs {
    ...
    boolean zzeO() {
        ...
        if (this.zzoG < 50 || this.zzoG > i) {
            ...
            if (this.zzDc) {
                ...
                switch (z) {
                    case false:
                        i2 = this.zzDd + this.zzDf;
                        i3 = this.zzDe + this.zzDg;
                        break;
                    case true:
                        i2 = ((this.zzDd + this.zzDf) + (this.zzoG / 2)) - 25;
                        i3 = this.zzDe + this.zzDg;
                        break;
                    case true:
                        i2 = ((this.zzDd + this.zzDf) + (this.zzoG / 2)) - 25;
                        i3 = ((this.zzDe + this.zzDg) + (this.zzoH / 2)) - 25;
                        break;
                    case true:
                        i2 = this.zzDd + this.zzDf;
                        i3 = ((this.zzDe + this.zzDg) + this.zzoH) - 50;
                        break;
                    case true:
                        i2 = ((this.zzDd + this.zzDf) + (this.zzoG / 2)) - 25;
                        i3 = ((this.zzDe + this.zzDg) + this.zzoH) - 50;
                        break;
                    case true:
                        i2 = ((this.zzDd + this.zzDf) + this.zzoG) - 50;
                        i3 = ((this.zzDe + this.zzDg) + this.zzoH) - 50;
                        break;
                    default:
                        i2 = ((this.zzDd + this.zzDf) + this.zzoG) - 50;
                ...
                if (i2 < 0 || i2 + 50 > i || r3 < zzh[0] || r3 + 50 > zzh[1]) {
                    return false;
                }
            }
            return true;
    ...
    L_0x0116:
        ...
        switch(r9) {
            case -1364013995: goto L_0x01f3;
            case -1012429441: goto L_0x01dd;
            case -655373719: goto L_0x01fe;
            case 1163912186: goto L_0x0214;
            case 1288627767: goto L_0x0209;
            case 1755462605: goto L_0x01e8;
    ...
    L_0x0163:
        ...
        r1 = r12.zzDl;	 Catch:{ RuntimeException -> 0x0262 }
        r2 = r7.getDecorView();	 Catch:{ RuntimeException -> 0x0262 }
        r3 = 0;
        r4 = com.google.android.gms.ads.internal.client.zzn.zzcS();	 Catch:{ RuntimeException -> 0x0262 }
        r5 = r12.zzDh;	 Catch:{ RuntimeException -> 0x0262 }
        r7 = 0;
        r7 = r8[r7];	 Catch:{ RuntimeException -> 0x0262 }
        r4 = r4.zzb(r5, r7);	 Catch:{ RuntimeException -> 0x0262 }
        r5 = com.google.android.gms.ads.internal.client.zzn.zzcS();	 Catch:{ RuntimeException -> 0x0262 }
        r7 = r12.zzDh;	 Catch:{ RuntimeException -> 0x0262 }
        r9 = 1;
        r9 = r8[r9];	 Catch:{ RuntimeException -> 0x0262 }
        r5 = r5.zzb(r7, r9);	 Catch:{ RuntimeException -> 0x0262 }
        r1.showAtLocation(r2, r3, r4, r5);	 Catch:{ RuntimeException -> 0x0262 }
        r1 = 0;

...
public final class zzmf {
    ...
    private static final zza<zzmj, NoOptions> zzUJ = new zza<zzmj, NoOptions>() {
        ...
        public final zzmj zzf(Context context, Looper looper, zzf com_google_android_gms_common_internal_zzf, NoOptions noOptions, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {

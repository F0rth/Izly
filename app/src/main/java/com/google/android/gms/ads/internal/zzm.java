        ...
        com_google_android_gms_internal_zzjp.zzhU().zza(new zzjq.zza() {
            public final void zza(zzjp com_google_android_gms_internal_zzjp, boolean z) {
                try {
                    ...
                    jSONObject.put(Item.KEY_PRICE, com_google_android_gms_ads_internal_formats_zzd.getPrice());
                    jSONObject.put("star_rating", String.valueOf(com_google_android_gms_ads_internal_formats_zzd.getStarRating()));
                    jSONObject.put("store", com_google_android_gms_ads_internal_formats_zzd.getStore());

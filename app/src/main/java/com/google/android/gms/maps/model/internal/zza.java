        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    zziz = zziz(parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeStrongBinder(zziz != null ? zziz.asBinder() : null);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    zziz = zzer(parcel.readString());
                    parcel2.writeNoException();
                    if (zziz != null) {
                ...
                case 6:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IBitmapDescriptorFactoryDelegate");
                    zziz = zzc(parcel.readInt() != 0 ? (Bitmap) Bitmap.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    if (zziz != null) {
                        iBinder = zziz.asBinder();
                    }

...
public class zzlv implements com.google.android.gms.clearcut.zzc {
    ...
    final class zzd extends zzc<Status> {
        ...
        protected final void zza(zzlw com_google_android_gms_internal_zzlw) throws RemoteException {
        ...
        protected final Status zzb(Status status) {
            return status;
        }

        protected final /* synthetic */ Result zzc(Status status) {
            return zzb(status);
        }
    }

...
public abstract class zzj<T extends IInterface> implements com.google.android.gms.common.api.Api.zzb, com.google.android.gms.common.internal.zzk.zza {
    ...
    final class zzb extends Handler {
        ...
        public final void handleMessage(Message message) {
            if (this.zzalL.zzalI.get() != message.arg1) {
                if (zzb(message)) {
                    zza(message);
                }
            } else if ((message.what == 1 || message.what == 5) && !this.zzalL.isConnecting()) {
                zza(message);
                ...
                if (this.zzalL.zzalF != null) {
                    this.zzalL.zzalF.onConnectionSuspended(message.arg2);
                }
                this.zzalL.onConnectionSuspended(message.arg2);
                this.zzalL.zza(4, 1, null);
            } else if (message.what == 2 && !this.zzalL.isConnected()) {
                zza(message);
            } else if (zzb(message)) {
    ...
    public final class zze implements ServiceConnection {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            synchronized (this.zzalL.zzaly) {
                this.zzalL.zzalz = com.google.android.gms.common.internal.zzs.zza.zzaS(iBinder);
            }
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (iInterface == null) {
            ...
            printWriter.append(zzgv()).append("@").println(Integer.toHexString(System.identityHashCode(iInterface.asBinder())));
        }
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(c.DATE_TIME_FORMAT, Locale.US);
        if (this.zzalu > 0) {
            printWriter.append(str).append("lastConnectedTime=").println(this.zzalu + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + simpleDateFormat.format(new Date(this.zzalu)));
        }
        if (this.zzalt > 0) {
            ...
            printWriter.append(" lastSuspendedTime=").println(this.zzalt + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + simpleDateFormat.format(new Date(this.zzalt)));
        }
        if (this.zzalw > 0) {
            printWriter.append(str).append("lastFailedStatus=").append(CommonStatusCodes.getStatusCodeString(this.zzalv));
            printWriter.append(" lastFailedTime=").println(this.zzalw + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + simpleDateFormat.format(new Date(this.zzalw)));
        }
    }

    ...
    static final class zza {
        ...
        public final boolean equals(Object obj) {
            if (this != obj) {
                ...
                if (!zzw.equal(this.zzSU, com_google_android_gms_common_internal_zzm_zza.zzSU)) {
                    return false;
                }
                if (!zzw.equal(this.zzamc, com_google_android_gms_common_internal_zzm_zza.zzamc)) {
                    return false;
                }
            }
            return true;
        ...
        public class zza implements ServiceConnection {
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                synchronized (this.zzami.zzamh.zzalZ) {
                    this.zzami.zzakD = iBinder;
                    this.zzami.zzamc = componentName;

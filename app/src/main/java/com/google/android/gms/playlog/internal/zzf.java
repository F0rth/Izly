        ...
        if (!this.zzbdU.isEmpty()) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    if (com_google_android_gms_playlog_internal_zzb_zza.zzbdI != null) {
                    ...
                    } else if (com_google_android_gms_playlog_internal_zzb_zza.zzbdG.equals(playLoggerContext)) {
                        ...
                        PlayLoggerContext playLoggerContext2 = com_google_android_gms_playlog_internal_zzb_zza.zzbdG;
                        arrayList.add(com_google_android_gms_playlog_internal_zzb_zza.zzbdH);

...
public class zzht extends zzb implements zzhw {
    ...
    private zza zzc(zza com_google_android_gms_internal_zzif_zza) {
        ...
        try {
            ...
            zzen[] com_google_android_gms_internal_zzenArr = new zzen[1];
            com_google_android_gms_internal_zzenArr[0] = new zzen(jSONObject, null, Arrays.asList(new String[]{"com.google.ads.mediation.admob.AdMobAdapter"}), null, null, Collections.emptyList(), Collections.emptyList(), jSONObject2.toString(), null, Collections.emptyList(), Collections.emptyList(), null, null, null, null, null);
            return new zza(com_google_android_gms_internal_zzif_zza.zzLd, com_google_android_gms_internal_zzif_zza.zzLe, new zzeo(Arrays.asList(com_google_android_gms_internal_zzenArr), -1, Collections.emptyList(), Collections.emptyList(), Collections.emptyList(), "", -1, 0, 1, null, 0, -1, -1), com_google_android_gms_internal_zzif_zza.zzrp, com_google_android_gms_internal_zzif_zza.errorCode, com_google_android_gms_internal_zzif_zza.zzKY, com_google_android_gms_internal_zzif_zza.zzKZ, com_google_android_gms_internal_zzif_zza.zzKT);
        } catch (Throwable e) {
    ...
    public zzia zzaw(String str) {
        zzia com_google_android_gms_internal_zzia;
        Throwable e;
        zzia com_google_android_gms_internal_zzia2 = (zzia) this.zzKw.get(str);
        if (com_google_android_gms_internal_zzia2 == null) {
            try {
                com_google_android_gms_internal_zzia = new zzia(("com.google.ads.mediation.admob.AdMobAdapter".equals(str) ? zzKv : this.zzpn).zzaf(str), this);
                try {
                    this.zzKw.put(str, com_google_android_gms_internal_zzia);
                    com_google_android_gms_internal_zzia2 = com_google_android_gms_internal_zzia;
                } catch (Exception e2) {
                    e = e2;

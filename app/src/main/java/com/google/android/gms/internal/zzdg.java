    ...
    protected JSONObject zza(zzd com_google_android_gms_internal_zzdg_zzd) {
        ...
        try {
            ...
            for (zza com_google_android_gms_internal_zzdg_zza : com_google_android_gms_internal_zzdg_zzd.zzdZ()) {
                jSONArray.put(new JSONObject().put("key", com_google_android_gms_internal_zzdg_zza.getKey()).put(Lead.KEY_VALUE, com_google_android_gms_internal_zzdg_zza.getValue()));
            }
    ...
    protected zzb zzc(JSONObject jSONObject) {
        ...
        for (int i = 0; i < optJSONArray.length(); i++) {
            ...
            if (optJSONObject != null) {
                arrayList.add(new zza(optJSONObject.optString("key"), optJSONObject.optString(Lead.KEY_VALUE)));
            }
        }

...
public class zzih implements zzb {
    ...
    L_0x0005:
        r0 = r2.zzLz;	 Catch:{ all -> 0x001a }
        r0 = r3.equals(r0);	 Catch:{ all -> 0x001a }
        if (r0 != 0) goto L_0x0017;
    L_0x000d:
        r2.zzLz = r3;	 Catch:{ all -> 0x001a }
        r0 = r2.mContext;	 Catch:{ all -> 0x001a }
        r0 = com.google.android.gms.internal.zzip.zzd(r0, r3);	 Catch:{ all -> 0x001a }

...
public interface ILocationSourceDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements ILocationSourceDelegate {
        ...
        static class zza implements ILocationSourceDelegate {
            ...
            public void activate(zzk com_google_android_gms_maps_internal_zzk) throws RemoteException {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    activate(com.google.android.gms.maps.internal.zzk.zza.zzcG(parcel.readStrongBinder()));

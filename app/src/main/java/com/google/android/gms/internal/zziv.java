...
public class zziv {
    ...
    public static class zza {
        ...
        public String toString() {
            return zzw.zzy(this).zzg("name", this.name).zzg("minBound", Double.valueOf(this.zzMt)).zzg("maxBound", Double.valueOf(this.zzMs)).zzg("percent", Double.valueOf(this.zzMu)).zzg(NewHtcHomeBadger.COUNT, Integer.valueOf(this.count)).toString();
        }
    }

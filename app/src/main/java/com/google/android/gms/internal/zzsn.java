...
public final class zzsn {
    ...
    public final void zzF(byte[] bArr) throws IOException {
        zzmB(bArr.length);
        zzH(bArr);
    }
    ...
    public final void zza(int i, zzsu com_google_android_gms_internal_zzsu) throws IOException {
        zzE(i, 2);
    ...
    public final void zzap(long j) throws IOException {
        zzau(j);
    }
    ...
    public final void zzaz(boolean z) throws IOException {
        zzmz(z ? 1 : 0);
    }
    ...
    public final void zzb(zzsu com_google_android_gms_internal_zzsu) throws IOException {
    ...
    public final void zzc(zzsu com_google_android_gms_internal_zzsu) throws IOException {
    ...
    public final void zze(int i, boolean z) throws IOException {
        zzE(i, 0);
        zzaz(z);
    }

    public final void zzgN(String str) throws IOException {
        try {
    ...
    public final void zzk(double d) throws IOException {
        zzaw(Double.doubleToLongBits(d));
    }

    public final void zzmB(int i) throws IOException {
        while ((i & -128) != 0) {
    ...
    public final void zzmD(int i) throws IOException {
    ...
    public final void zzmv(int i) throws IOException {
        if (i >= 0) {
            zzmB(i);
        } else {
            zzau((long) i);
    ...
    public final void zzmz(int i) throws IOException {
        zzb((byte) i);
    }

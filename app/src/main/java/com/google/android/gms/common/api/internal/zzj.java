...
public final class zzj extends GoogleApiClient implements com.google.android.gms.common.api.internal.zzp.zza {
    ...
    static class zzb implements DeathRecipient, zzd {
    ...
    public static int zza(Iterable<com.google.android.gms.common.api.Api.zzb> iterable, boolean z) {
        ...
        for (com.google.android.gms.common.api.Api.zzb com_google_android_gms_common_api_Api_zzb : iterable) {
            ...
            i2 = com_google_android_gms_common_api_Api_zzb.zznb() ? 1 : i2;
        }
    ...
    private void zzbB(int i) {
        ...
        if (this.zzahM == null) {
            ...
            for (com.google.android.gms.common.api.Api.zzb com_google_android_gms_common_api_Api_zzb : this.zzahT.values()) {
                ...
                obj2 = com_google_android_gms_common_api_Api_zzb.zznb() ? 1 : obj2;
            }
    ...
    public final ConnectionResult blockingConnect(long j, @NonNull TimeUnit timeUnit) {
        ...
        try {
            ...
            zzbB(this.zzahZ.intValue());
            this.zzahL.zzqR();
            ConnectionResult blockingConnect = this.zzahM.blockingConnect(j, timeUnit);
            return blockingConnect;
        } finally {
            this.zzXG.unlock();
        }
                ...
                new Handler(this.mContext.getMainLooper()).post(new Runnable(this) {
                    ...
                    public void run() {
                        if (!fragmentActivity.isFinishing() && !fragmentActivity.getSupportFragmentManager().isDestroyed()) {
                            zzw.zzb(fragmentActivity).zzbD(this.zzaid.zzagp);
                        }
                    }
                });
                return;
    ...
    @NonNull
    public final <C extends com.google.android.gms.common.api.Api.zzb> C zza(@NonNull com.google.android.gms.common.api.Api.zzc<C> com_google_android_gms_common_api_Api_zzc_C) {
    ...
    public final <A extends com.google.android.gms.common.api.Api.zzb, R extends Result, T extends com.google.android.gms.common.api.internal.zza.zza<R, A>> T zza(@NonNull T t) {
    ...
    public final boolean zza(zzu com_google_android_gms_common_api_internal_zzu) {
        return this.zzahM != null && this.zzahM.zza(com_google_android_gms_common_api_internal_zzu);
    }

    final void zzaa(boolean z) {
    ...
    public final <A extends com.google.android.gms.common.api.Api.zzb, T extends com.google.android.gms.common.api.internal.zza.zza<? extends Result, A>> T zzb(@NonNull T t) {
    ...
    final <A extends com.google.android.gms.common.api.Api.zzb> void zzb(zze<A> com_google_android_gms_common_api_internal_zzj_zze_A) {
    ...
    public final void zzb(zzx com_google_android_gms_common_api_internal_zzx) {
        this.zzXG.lock();
        try {
            if (this.zzaia == null) {
    ...
    public final <L> zzq<L> zzr(@NonNull L l) {

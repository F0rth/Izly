...
public final class zzeq extends zza {
    ...
    public final void zza(zzep com_google_android_gms_internal_zzep) {
        synchronized (this.zzpV) {
            this.zzCc = com_google_android_gms_internal_zzep;
        }
    }

    public final void zza(zzes.zza com_google_android_gms_internal_zzes_zza) {
        synchronized (this.zzpV) {
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void zza(com.google.android.gms.internal.zzfa r4) {
        /*
        r3 = this;
        r1 = r3.zzpV;
        monitor-enter(r1);

...
public class zzh implements zzk {
    ...
    static class zza implements com.google.android.gms.common.api.GoogleApiClient.zza {
    ...
    class zze implements ConnectionCallbacks, OnConnectionFailedListener {
        ...
        public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
            this.zzahC.zzXG.lock();
            try {
                if (this.zzahC.zzf(connectionResult)) {
                    this.zzahC.zzpy();
                    this.zzahC.zzpv();
                } else {
                    this.zzahC.zzg(connectionResult);
                }
                this.zzahC.zzXG.unlock();
            } catch (Throwable th) {
                this.zzahC.zzXG.unlock();
    ...
    public void begin() {
        ...
        for (Api api : this.zzahA.keySet()) {
            ...
            int i2 = api.zzoP().getPriority() == 1 ? 1 : 0;

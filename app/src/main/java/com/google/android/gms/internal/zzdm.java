...
public final class zzdm implements zzdf {
    ...
    public static class zza extends zzim {
        ...
        public void zzbr() {
            ...
            com.google.android.gms.ads.internal.util.client.zzb.zzd("Error while pinging URL: " + str2, e);
            str = str2;
            zzr.zzbC().zzb(this.zzpD.getContext(), zzT(str));
            com.google.android.gms.ads.internal.util.client.zzb.zzd("Error while parsing ping URL: " + str2, e);
            str = str2;
            zzr.zzbC().zzb(this.zzpD.getContext(), zzT(str));
            com.google.android.gms.ads.internal.util.client.zzb.zzd("Error while pinging URL: " + str2, e);
            str = str2;

...
public class zzk extends zza implements OnClickListener, OnTouchListener, OnGlobalLayoutListener, OnScrollChangedListener {
    ...
    L_0x0008:
        return;
    L_0x0009:
        r3 = new org.json.JSONObject;	 Catch:{ all -> 0x008d }
        r3.<init>();	 Catch:{ all -> 0x008d }
        r0 = r9.zzyE;	 Catch:{ all -> 0x008d }
        r0 = r0.entrySet();	 Catch:{ all -> 0x008d }
        r2 = r0.iterator();	 Catch:{ all -> 0x008d }
    L_0x0018:
        r0 = r2.hasNext();	 Catch:{ all -> 0x008d }
        if (r0 == 0) goto L_0x0090;
    L_0x001e:
        r0 = r2.next();	 Catch:{ all -> 0x008d }
        r0 = (java.util.Map.Entry) r0;	 Catch:{ all -> 0x008d }
        r1 = r0.getValue();	 Catch:{ all -> 0x008d }
        r1 = (java.lang.ref.WeakReference) r1;	 Catch:{ all -> 0x008d }
        r1 = r1.get();	 Catch:{ all -> 0x008d }
        r1 = (android.view.View) r1;	 Catch:{ all -> 0x008d }
        r4 = r9.zzj(r1);	 Catch:{ all -> 0x008d }
        r5 = new org.json.JSONObject;	 Catch:{ all -> 0x008d }
    ...
    L_0x0073:
        r1 = move-exception;
        r1 = new java.lang.StringBuilder;	 Catch:{ all -> 0x008d }
        r4 = "Unable to get view rectangle for view ";
        r1.<init>(r4);	 Catch:{ all -> 0x008d }
        r0 = r0.getKey();	 Catch:{ all -> 0x008d }
        r0 = (java.lang.String) r0;	 Catch:{ all -> 0x008d }
        r0 = r1.append(r0);	 Catch:{ all -> 0x008d }
        r0 = r0.toString();	 Catch:{ all -> 0x008d }
        com.google.android.gms.ads.internal.util.client.zzb.zzaK(r0);	 Catch:{ all -> 0x008d }
        goto L_0x0018;
    L_0x008d:
        r0 = move-exception;
        monitor-exit(r6);	 Catch:{ all -> 0x008d }
        throw r0;
    L_0x0090:
        r4 = new org.json.JSONObject;	 Catch:{ all -> 0x008d }
        r4.<init>();	 Catch:{ all -> 0x008d }
        r0 = "x";
        r1 = r9.zzyH;	 Catch:{ JSONException -> 0x00e4 }
        r1 = r9.zzq(r1);	 Catch:{ JSONException -> 0x00e4 }
        r4.put(r0, r1);	 Catch:{ JSONException -> 0x00e4 }
        r0 = "y";
        r1 = r9.zzyI;	 Catch:{ JSONException -> 0x00e4 }
        r1 = r9.zzq(r1);	 Catch:{ JSONException -> 0x00e4 }
        r4.put(r0, r1);	 Catch:{ JSONException -> 0x00e4 }
    L_0x00ab:
        r5 = new org.json.JSONObject;	 Catch:{ all -> 0x008d }
        r5.<init>();	 Catch:{ all -> 0x008d }
        r0 = "width";
        r1 = r9.getMeasuredWidth();	 Catch:{ JSONException -> 0x00eb }
        r1 = r9.zzq(r1);	 Catch:{ JSONException -> 0x00eb }
        r5.put(r0, r1);	 Catch:{ JSONException -> 0x00eb }
        r0 = "height";
        r1 = r9.getMeasuredHeight();	 Catch:{ JSONException -> 0x00eb }
        r1 = r9.zzq(r1);	 Catch:{ JSONException -> 0x00eb }
        r5.put(r0, r1);	 Catch:{ JSONException -> 0x00eb }
    L_0x00ca:
        r0 = r9.zzyF;	 Catch:{ all -> 0x008d }
    ...
    L_0x00ce:
        r0 = r9.zzyF;	 Catch:{ all -> 0x008d }
        r0 = r0.zzdI();	 Catch:{ all -> 0x008d }
        r0 = r0.equals(r10);	 Catch:{ all -> 0x008d }
        if (r0 == 0) goto L_0x00f2;
    L_0x00da:
        r0 = r9.zzyf;	 Catch:{ all -> 0x008d }
        r1 = "1007";
        r0.zza(r1, r3, r4, r5);	 Catch:{ all -> 0x008d }
    L_0x00e1:
        monitor-exit(r6);	 Catch:{ all -> 0x008d }
        goto L_0x0008;
    L_0x00e4:
    ...
    L_0x00f2:
        r0 = r9.zzyf;	 Catch:{ all -> 0x008d }
        r2 = r9.zzyE;	 Catch:{ all -> 0x008d }
        r1 = r10;
        r0.zza(r1, r2, r3, r4, r5);	 Catch:{ all -> 0x008d }
        goto L_0x00e1;
        */

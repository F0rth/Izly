...
public final class zzbt {
    ...
    public static final zzbp<Integer> zzvP = zzbp.zza(0, "gads:video_stream_cache:limit_space", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);
    public static final zzbp<Integer> zzvQ = zzbp.zza(0, "gads:video_stream_exo_cache:buffer_size", (int) GravityCompat.RELATIVE_LAYOUT_DIRECTION);

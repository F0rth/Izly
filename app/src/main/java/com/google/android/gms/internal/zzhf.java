...
public final class zzhf {
    ...
    public final void zzb(zzd com_google_android_gms_internal_zzeg_zzd) {
        this.zzJj = com_google_android_gms_internal_zzeg_zzd;
    }

    public final zzd zzgB() {
        return this.zzJj;
    }

    public final Future<zzhi> zzgC() {
        return this.zzJi;
    }
    ...
    public final void zzh(zzjp com_google_android_gms_internal_zzjp) {

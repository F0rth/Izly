...
public class zzd {
    ...
    public static void clearToken(Context context, final String str) throws GooglePlayServicesAvailabilityException, GoogleAuthException, IOException {
        ...
        zza(context, zzVe, new zza<Void>() {
            public final /* synthetic */ Object zzan(IBinder iBinder) throws RemoteException, IOException, GoogleAuthException {
                return zzao(iBinder);
            }

            public final Void zzao(IBinder iBinder) throws RemoteException, IOException, GoogleAuthException {
                Bundle bundle = (Bundle) zzd.zzm(com.google.android.gms.internal.zzas.zza.zza(iBinder).zza(str, bundle));
    ...
    public static List<AccountChangeEvent> getAccountChangeEvents(Context context, final int i, final String str) throws GoogleAuthException, IOException {
        ...
        return (List) zza(context, zzVe, new zza<List<AccountChangeEvent>>() {
            ...
            public final List<AccountChangeEvent> zzap(IBinder iBinder) throws RemoteException, IOException, GoogleAuthException {
                return ((AccountChangeEventsResponse) zzd.zzm(com.google.android.gms.internal.zzas.zza.zza(iBinder).zza(new AccountChangeEventsRequest().setAccountName(str).setEventIndex(i)))).getEvents();
            }
        });
    }
    ...
    public static TokenData zzc(Context context, final Account account, final String str, Bundle bundle) throws IOException, UserRecoverableAuthException, GoogleAuthException {
        ...
        return (TokenData) zza(context, zzVe, new zza<TokenData>() {
            public final TokenData zzam(IBinder iBinder) throws RemoteException, IOException, GoogleAuthException {

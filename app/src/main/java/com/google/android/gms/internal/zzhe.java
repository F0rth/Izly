...
public final class zzhe {
    ...
    public static AdResponseParcel zza(Context context, AdRequestInfoParcel adRequestInfoParcel, String str) {
        try {
            ...
            int zzhw = "portrait".equals(optString7) ? zzr.zzbE().zzhw() : "landscape".equals(optString7) ? zzr.zzbE().zzhv() : -1;
            if (TextUtils.isEmpty(optString5)) {
                if (TextUtils.isEmpty(optString3)) {
                    zzb.zzaK("Could not parse the mediation config: Missing required " + (z ? "ad_json" : "ad_html") + " or ad_url" + " field.");
                    return new AdResponseParcel(0);
                }
                zza = zzhd.zza(adRequestInfoParcel, context, adRequestInfoParcel.zzrl.afmaVersion, optString3, null, null, null, null, null);
                optString2 = zza.zzEF;
                str2 = zza.body;
                j2 = zza.zzHX;
    ...
    private static void zza(HashMap<String, Object> hashMap, Location location) {
        ...
        hashMap2.put(GeofencesColumns.RADIUS, Float.valueOf(accuracy * 1000.0f));

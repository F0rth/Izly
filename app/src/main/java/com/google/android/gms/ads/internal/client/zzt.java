...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        static class zza implements zzt {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                case 1:
                    ...
                    IBinder zza = zza(com.google.android.gms.dynamic.zzd.zza.zzbs(parcel.readStrongBinder()), parcel.readString(), com.google.android.gms.internal.zzex.zza.zzE(parcel.readStrongBinder()), parcel.readInt());

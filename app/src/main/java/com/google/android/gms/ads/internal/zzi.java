...
public class zzi extends zza {
    ...
    public java.lang.String getMediationAdapterClassName() {
        ...
        r2 = r3.zzpV;
        monitor-enter(r2);
        r0 = r3.zzpU;	 Catch:{ all -> 0x001b }
        if (r0 == 0) goto L_0x0018;
    L_0x0008:
        r0 = r3.zzpU;	 Catch:{ all -> 0x001b }
        r0 = r0.get();	 Catch:{ all -> 0x001b }
        r0 = (com.google.android.gms.ads.internal.zzp) r0;	 Catch:{ all -> 0x001b }
        if (r0 == 0) goto L_0x001e;
    L_0x0012:
        r0 = r0.getMediationAdapterClassName();	 Catch:{ all -> 0x001b }
    L_0x0016:
    ...
    L_0x0008:
        ...
        if (r0 == 0) goto L_0x001e;
    L_0x0012:
        r0 = r0.isLoading();	 Catch:{ all -> 0x001b }
    L_0x0016:
        monitor-exit(r2);	 Catch:{ all -> 0x001b }
    L_0x0017:
        return r0;

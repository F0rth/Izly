...
public abstract class zzb<R extends Result> extends PendingResult<R> {
    ...
    L_0x0007:
        ...
        r3 = r4.zzagI;
        monitor-enter(r3);
        r0 = r4.zzagS;	 Catch:{ all -> 0x0037 }
        if (r0 != 0) goto L_0x0050;
    L_0x0013:
        r0 = "Cannot set callbacks if then() has been called.";
        com.google.android.gms.common.internal.zzx.zza(r1, r0);	 Catch:{ all -> 0x0037 }
        r0 = r4.isCanceled();	 Catch:{ all -> 0x0037 }
    ...
    L_0x001f:
        return;
    L_0x0020:
        r0 = r4.zzagP;	 Catch:{ all -> 0x0037 }
        if (r0 == 0) goto L_0x003a;
    L_0x0024:
        r0 = r4.zzagK;	 Catch:{ all -> 0x0037 }
        r0 = r0.get();	 Catch:{ all -> 0x0037 }
        r0 = (com.google.android.gms.common.api.GoogleApiClient) r0;	 Catch:{ all -> 0x0037 }
        if (r0 == 0) goto L_0x0032;
    L_0x002e:
        r0 = r5 instanceof com.google.android.gms.common.api.internal.zzx;	 Catch:{ all -> 0x0037 }
        if (r0 != 0) goto L_0x003a;
    L_0x0032:
        r4.cancel();	 Catch:{ all -> 0x0037 }
        monitor-exit(r3);	 Catch:{ all -> 0x0037 }
        goto L_0x001f;
    L_0x0037:
        r0 = move-exception;
        ...
        throw r0;
    L_0x003a:
        r0 = r4.isReady();	 Catch:{ all -> 0x0037 }
        if (r0 == 0) goto L_0x004b;
    L_0x0040:
        r0 = r4.zzagJ;	 Catch:{ all -> 0x0037 }
        r1 = r4.get();	 Catch:{ all -> 0x0037 }
        r0.zza(r5, r1);	 Catch:{ all -> 0x0037 }
    L_0x0049:
        monitor-exit(r3);	 Catch:{ all -> 0x0037 }
        goto L_0x001f;
    L_0x004b:
        r4.zzagM = r5;	 Catch:{ all -> 0x0037 }
        goto L_0x0049;
    L_0x004e:
        r0 = r2;
        goto L_0x0007;
    ...
    L_0x0007:
        ...
        r3 = r6.zzagI;
        monitor-enter(r3);
        r0 = r6.zzagS;	 Catch:{ all -> 0x0037 }
        if (r0 != 0) goto L_0x0059;
    L_0x0013:
        r0 = "Cannot set callbacks if then() has been called.";
        com.google.android.gms.common.internal.zzx.zza(r1, r0);	 Catch:{ all -> 0x0037 }
        r0 = r6.isCanceled();	 Catch:{ all -> 0x0037 }
        if (r0 == 0) goto L_0x0020;
    L_0x001e:
        monitor-exit(r3);	 Catch:{ all -> 0x0037 }
    L_0x001f:
        return;
    L_0x0020:
        r0 = r6.zzagP;	 Catch:{ all -> 0x0037 }
        if (r0 == 0) goto L_0x003a;
    L_0x0024:
        r0 = r6.zzagK;	 Catch:{ all -> 0x0037 }
        r0 = r0.get();	 Catch:{ all -> 0x0037 }
        r0 = (com.google.android.gms.common.api.GoogleApiClient) r0;	 Catch:{ all -> 0x0037 }
        if (r0 == 0) goto L_0x0032;
    L_0x002e:
        r0 = r7 instanceof com.google.android.gms.common.api.internal.zzx;	 Catch:{ all -> 0x0037 }
        if (r0 != 0) goto L_0x003a;
    L_0x0032:
        r6.cancel();	 Catch:{ all -> 0x0037 }
        monitor-exit(r3);	 Catch:{ all -> 0x0037 }
        goto L_0x001f;
    L_0x0037:
        r0 = move-exception;
        ...
        throw r0;
    L_0x003a:
        r0 = r6.isReady();	 Catch:{ all -> 0x0037 }
        if (r0 == 0) goto L_0x004b;
    L_0x0040:
        r0 = r6.zzagJ;	 Catch:{ all -> 0x0037 }
        r1 = r6.get();	 Catch:{ all -> 0x0037 }
        r0.zza(r7, r1);	 Catch:{ all -> 0x0037 }
    L_0x0049:
        monitor-exit(r3);	 Catch:{ all -> 0x0037 }
        goto L_0x001f;
    L_0x004b:
        r6.zzagM = r7;	 Catch:{ all -> 0x0037 }
        r0 = r6.zzagJ;	 Catch:{ all -> 0x0037 }
        r4 = r10.toMillis(r8);	 Catch:{ all -> 0x0037 }
        r0.zza(r6, r4);	 Catch:{ all -> 0x0037 }
        goto L_0x0049;
    L_0x0057:
        r0 = r2;
        goto L_0x0007;

...
public interface Resource {
    ...
    public static final class ResourceWithMetadata extends ExtendableMessageNano {
        ...
        public final int getSerializedSize() {
            int computeInt64Size = CodedOutputByteBufferNano.computeInt64Size(1, this.timeStamp) + 0;
        ...
        public final int hashCode() {
            int i = 0;
            int i2 = (int) (this.timeStamp ^ (this.timeStamp >>> 32));
            int hashCode = this.resource == null ? 0 : this.resource.hashCode();
            int hashCode2 = this.supplementedResource == null ? 0 : this.supplementedResource.hashCode();
            if (this.unknownFieldData != null) {
                i = this.unknownFieldData.hashCode();
            }
            return ((((hashCode + ((i2 + 527) * 31)) * 31) + hashCode2) * 31) + i;
        }

        public final ResourceWithMetadata mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
            while (true) {

...
public class Container {
    ...
    class FunctionCallMacroHandlerAdapter implements CustomEvaluator {
    ...
    class FunctionCallTagHandlerAdapter implements CustomEvaluator {
    ...
    private void saveResourceToDisk(SupplementedResource supplementedResource) {
        synchronized (this) {
    ...
    public FunctionCallMacroHandler getFunctionCallMacroHandler(String str) {
        FunctionCallMacroHandler functionCallMacroHandler;
        synchronized (this) {
            functionCallMacroHandler = (FunctionCallMacroHandler) this.mFunctionCallMacroHandlers.get(str);
        }
        return functionCallMacroHandler;
    }

    public FunctionCallTagHandler getFunctionCallTagHandler(String str) {
        FunctionCallTagHandler functionCallTagHandler;
        synchronized (this) {
            functionCallTagHandler = (FunctionCallTagHandler) this.mFunctionCallTagHandlers.get(str);
        }
    ...
    public void registerFunctionCallMacroHandler(String str, FunctionCallMacroHandler functionCallMacroHandler) {
        synchronized (this) {
            this.mFunctionCallMacroHandlers.put(str, functionCallMacroHandler);
        }
    }

    public void registerFunctionCallTagHandler(String str, FunctionCallTagHandler functionCallTagHandler) {
        synchronized (this) {

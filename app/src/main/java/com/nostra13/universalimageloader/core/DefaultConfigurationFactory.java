...
public class DefaultConfigurationFactory {
    ...
    public static MemoryCache createMemoryCache(Context context, int i) {
        if (i == 0) {
            ...
            int largeMemoryClass = (hasHoneycomb() && isLargeHeap(context)) ? getLargeMemoryClass(activityManager) : activityManager.getMemoryClass();
            i = (largeMemoryClass * PKIFailureInfo.badCertTemplate) / 8;
        }
    ...
    private static boolean isLargeHeap(Context context) {
        return (context.getApplicationInfo().flags & PKIFailureInfo.badCertTemplate) != 0;
    }
}

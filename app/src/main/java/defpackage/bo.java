...
public final class bo extends DefaultHandler {
    ...
    public final void endElement(String str, String str2, String str3) throws SAXException {
        ...
        if (this.c) {
            ...
            if (this.e.toString().length() > 0) {
                this.b.c = Double.parseDouble(this.e.toString());
                return;
            }
            this.b.c = -1.0d;
        } else if (str2.equals(AdwHomeBadger.COUNT)) {
            this.b.e = Integer.parseInt(this.e.toString());
        } else if (str2.equals("MSG")) {
            this.b.f = this.e.toString();

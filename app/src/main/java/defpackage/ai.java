...
public final class ai {
    public static Bundle a(String str) throws JSONException, ParseException {
        ...
        if (jSONObject.isNull("ErrorMessage")) {
            JSONObject jSONObject2 = jSONObject.getJSONObject("CheckMoneyDemandForProResult");
            CheckMoneyDemandForProData checkMoneyDemandForProData = new CheckMoneyDemandForProData();
            if (!jSONObject2.isNull("UP")) {
                jSONObject = jSONObject2.getJSONObject("UP");
                checkMoneyDemandForProData.a.a = Double.parseDouble(jSONObject.getString("BAL"));
                checkMoneyDemandForProData.a.c = ae.a.parse(jSONObject.getString("LUD")).getTime();
            }
            if (!jSONObject2.isNull("Demands")) {
                ...
                checkMoneyDemandForProData.b = arrayList;
            }
            if (!jSONObject2.isNull("Total")) {
                jSONObject = jSONObject2.getJSONObject("Total");
                if (!jSONObject.isNull("AmountHT")) {
                    checkMoneyDemandForProData.f = Float.parseFloat(jSONObject.getString("AmountHT"));
                }
                if (!jSONObject.isNull("AmountTTC")) {
                    checkMoneyDemandForProData.g = Float.parseFloat(jSONObject.getString("AmountTTC"));
                }
                if (!jSONObject.isNull("Tax")) {
                    checkMoneyDemandForProData.h = Float.parseFloat(jSONObject.getString("Tax"));
                }
            }
            if (!jSONObject2.isNull("Message")) {
                checkMoneyDemandForProData.d = jSONObject2.getString("Message");
            }
            checkMoneyDemandForProData.e = jk.a(jSONObject2.getString("OperationDate"));
            if (!jSONObject2.isNull("Id")) {
                checkMoneyDemandForProData.c = jSONObject2.getLong("Id");
            }
            parcelable2 = checkMoneyDemandForProData;
            parcelable = null;
        } else {
        ...
        if (parcelable2 != null) {
            bundle.putParcelable("fr.smoney.android.izly.extras.CheckMoneyDemandForPro", parcelable2);
        }
        return bundle;
    }
}

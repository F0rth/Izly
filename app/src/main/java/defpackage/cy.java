...
public final class cy {
    public static Bundle a(String str, String str2, String str3, boolean z) throws JSONException, ClientProtocolException, IOException {
        ...
        cq cqVar = new cq("https://rest.izly.fr/Service/PublicService.svc/rest/BlockOrUnblockContact");
        ...
        if (parcelable2 != null) {
            bundle.putParcelable("fr.smoney.android.izly.extras.blockContactData", parcelable2);
        }
        return bundle;
    }
}

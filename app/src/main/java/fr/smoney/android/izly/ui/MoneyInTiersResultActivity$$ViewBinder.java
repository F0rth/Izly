...
public class MoneyInTiersResultActivity$$ViewBinder<T extends MoneyInTiersResultActivity> implements ViewBinder<T> {
    public void bind(Finder finder, final T t, Object obj) {
        ...
        ((View) finder.findRequiredView(obj, R.id.b_close, "method 'close'")).setOnClickListener(new DebouncingOnClickListener(this) {
            final /* synthetic */ MoneyInTiersResultActivity$$ViewBinder b;

    ...
    public static class SupportManagerFragment extends android.support.v4.app.Fragment {
        ...
        public void onEventMainThread(ThrowableFailureEvent throwableFailureEvent) {
            if (ErrorDialogManager.isInExecutionScope(this.executionScope, throwableFailureEvent)) {
                ...
                dialogFragment = (android.support.v4.app.DialogFragment) ErrorDialogManager.factory.prepareErrorFragment(throwableFailureEvent, this.finishAfterDialog, this.argumentsForErrorDialog);
                if (dialogFragment != null) {
                    dialogFragment.show(fragmentManager, ErrorDialogManager.TAG_ERROR_DIALOG);
                }
            }

...
public class OkHttpClient implements Cloneable, Factory {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            this.connectTimeout = kh.DEFAULT_TIMEOUT;
            this.readTimeout = kh.DEFAULT_TIMEOUT;
            this.writeTimeout = kh.DEFAULT_TIMEOUT;
        }
    ...
    static {
        List arrayList = new ArrayList(Arrays.asList(new ConnectionSpec[]{ConnectionSpec.MODERN_TLS, ConnectionSpec.COMPATIBLE_TLS}));
    ...
    private OkHttpClient(Builder builder) {
        ...
        for (ConnectionSpec isTls : this.connectionSpecs) {
            Object obj2 = (obj != null || isTls.isTls()) ? 1 : null;
            obj = obj2;
        }

...
public class ScriptIntrinsicBlend extends ScriptIntrinsic {
    ...
    public static ScriptIntrinsicBlend create(RenderScript renderScript, Element element) {
        return RenderScript.isNative ? ScriptIntrinsicBlendThunker.create(renderScript, element) : new ScriptIntrinsicBlend(renderScript.nScriptIntrinsicCreate(7, element.getID(renderScript)), renderScript);
    }

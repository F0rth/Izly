...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                int access$1100 = !SwipeRefreshLayout.this.mUsingCustomStart ? (int) (SwipeRefreshLayout.this.mSpinnerFinalOffset - ((float) Math.abs(SwipeRefreshLayout.this.mOriginalOffsetTop))) : (int) SwipeRefreshLayout.this.mSpinnerFinalOffset;
                access$1100 = (int) (((float) (access$1100 - SwipeRefreshLayout.this.mFrom)) * f);
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((access$1100 + SwipeRefreshLayout.this.mFrom) - SwipeRefreshLayout.this.mCircleView.getTop(), false);
    ...
    private float getMotionEventY(MotionEvent motionEvent, int i) {
        ...
        return findPointerIndex < 0 ? GroundOverlayOptions.NO_DIMENSION : MotionEventCompat.getY(motionEvent, findPointerIndex);
    }
    ...
    private void moveSpinner(float f) {
        ...
        abs = Math.max(0.0f, Math.min(abs - f2, f3 * DECELERATE_INTERPOLATION_FACTOR) / f3);

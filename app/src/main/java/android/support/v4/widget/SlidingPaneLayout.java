        ...
        while (i6 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    layoutParams.dimWhenOffset = ((paddingRight + i8) + min) + (measuredWidth / 2) > i5 - paddingLeft;
                    i9 = (int) (((float) min) * this.mSlideOffset);
                    i10 = paddingRight + (i8 + i9);
                    this.mSlideOffset = ((float) i9) / ((float) this.mSlideRange);
                    i9 = 0;
                } else {
                    i9 = (!this.mCanSlide || this.mParallaxBy == 0) ? 0 : (int) ((1.0f - this.mSlideOffset) * ((float) this.mParallaxBy));
                    i10 = i7;
                }
                if (isLayoutRtlSupport) {
                    i9 += i5 - i10;
        ...
        if (this.mFirstLayout) {
            if (this.mCanSlide) {
                ...
                for (i9 = 0; i9 < childCount; i9++) {
                    dimChildView(getChildAt(i9), 0.0f, this.mSliderFadeColor);
                }
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                i8 = layoutParams.width == -2 ? MeasureSpec.makeMeasureSpec(paddingLeft - i8, Integer.MIN_VALUE) : layoutParams.width == -1 ? MeasureSpec.makeMeasureSpec(paddingLeft - i8, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.width, 1073741824);
                makeMeasureSpec = layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(mode2, Integer.MIN_VALUE) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(mode2, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824);
                ...
                if (childAt2.getVisibility() != 8) {
                    ...
                    if (childAt2.getVisibility() != 8) {
                        ...
                        if (!z || childAt2 == this.mSlideableView) {
                            if (layoutParams.weight > 0.0f) {
                                i8 = layoutParams.width == 0 ? layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(mode2, Integer.MIN_VALUE) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(mode2, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824) : MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), 1073741824);
                                if (z) {
                                    size = paddingLeft - (layoutParams.rightMargin + layoutParams.leftMargin);
                                    i5 = MeasureSpec.makeMeasureSpec(size, 1073741824);
                                    if (makeMeasureSpec != size) {
                                        childAt2.measure(i5, i8);
                                    }
                                } else {
                                    childAt2.measure(MeasureSpec.makeMeasureSpec(((int) ((layoutParams.weight * ((float) Math.max(0, i6))) / f)) + makeMeasureSpec, 1073741824), i8);
                                }
                            }
                        } else if (layoutParams.width < 0 && (makeMeasureSpec > i9 || layoutParams.weight > 0.0f)) {
                            size = obj != null ? layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(mode2, Integer.MIN_VALUE) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(mode2, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824) : MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), 1073741824);

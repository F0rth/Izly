    ...
    private void setupAnimators() {
        ...
        Animation anonymousClass1 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                if (f <= 0.5f) {
                    ring.setStartTrim(startingStartTrim + (MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(f / 0.5f) * (MaterialProgressDrawable.MAX_PROGRESS_ARC - access$100)));
                }
                if (f > 0.5f) {
                ...
                MaterialProgressDrawable.this.setRotation(((MaterialProgressDrawable.this.mRotationCount / 5.0f) * MaterialProgressDrawable.FULL_ROTATION) + (216.0f * f));
            }
        };

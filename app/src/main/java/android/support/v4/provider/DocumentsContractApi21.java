...
class DocumentsContractApi21 {
    ...
    public static Uri[] listFiles(Context context, Uri uri) {
        ...
        try {
            autoCloseable2 = contentResolver.query(buildChildDocumentsUriUsingTree, new String[]{"document_id"}, null, null, null);
            while (autoCloseable2.moveToNext()) {
                try {
                    arrayList.add(DocumentsContract.buildDocumentUriUsingTree(uri, autoCloseable2.getString(0)));
                } catch (Exception e2) {
                    e = e2;
                }
            }

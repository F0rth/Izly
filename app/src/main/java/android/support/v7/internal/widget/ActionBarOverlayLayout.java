...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int combineMeasuredStates2 = ViewUtils.combineMeasuredStates(0, ViewCompat.getMeasuredState(this.mActionBarTop));
        if (this.mActionBarBottom != null) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates2, ViewCompat.getMeasuredState(this.mActionBarBottom));
            max4 = max;
            combineMeasuredStates2 = max2;
            i3 = combineMeasuredStates;
        } else {
            i3 = combineMeasuredStates2;
            combineMeasuredStates2 = max4;
            max4 = max3;
        }
        Object obj = (ViewCompat.getWindowSystemUiVisibility(this) & 256) != 0 ? 1 : null;
        if (obj != null) {
            max2 = this.mActionBarHeight;
            if (this.mHasNonEmbeddedTabs && this.mActionBarTop.getTabContainer() != null) {
                max2 += this.mActionBarHeight;
            }
        } else {
            max2 = this.mActionBarTop.getVisibility() != 8 ? this.mActionBarTop.getMeasuredHeight() : 0;
        }
        ...
        max2 = Math.max(combineMeasuredStates2, layoutParams.bottomMargin + (this.mContent.getMeasuredHeight() + layoutParams.topMargin));
        combineMeasuredStates = ViewUtils.combineMeasuredStates(i3, ViewCompat.getMeasuredState(this.mContent));
        setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(max + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, combineMeasuredStates), ViewCompat.resolveSizeAndState(Math.max(max2 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, combineMeasuredStates << 16));
    }

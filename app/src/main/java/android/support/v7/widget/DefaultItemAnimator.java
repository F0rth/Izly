        ...
        if (i != 0 || i2 != 0 || i4 != 0 || i3 != 0) {
            ...
            if (i4 != 0) {
                ...
                if (i == 0 && i2 == 0 && i3 == 0) {
                    ...
                    ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, anonymousClass3, (i != 0 ? getRemoveDuration() : 0) + Math.max(i2 != 0 ? getMoveDuration() : 0, i3 != 0 ? getChangeDuration() : 0));
                }
            }
        }
    }

...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    L_0x0036:
        r4 = android.support.v4.view.MotionEventCompat.getX(r12, r13);
        r5 = android.support.v4.view.MotionEventCompat.getY(r12, r13);
    ...
    L_0x006e:
        r10.mDy = r9;
        r10.mDx = r9;
        r1 = android.support.v4.view.MotionEventCompat.getPointerId(r12, r1);
    ...
    private ViewHolder findSwipedView(MotionEvent motionEvent) {
        ...
        if (this.mActivePointerId != -1) {
            ...
            x = Math.abs(x - f);
            y = Math.abs(y - f2);
            if ((x >= ((float) this.mSlop) || y >= ((float) this.mSlop)) && ((x <= y || !layoutManager.canScrollHorizontally()) && (y <= x || !layoutManager.canScrollVertically()))) {
                View findChildView = findChildView(motionEvent);

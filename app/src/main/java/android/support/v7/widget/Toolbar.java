...
public class Toolbar extends ViewGroup {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!shouldLayout(this.mLogoView)) {
            ...
            i6 = i5;
            i7 = layoutChildRight(this.mLogoView, i8, iArr, minimumHeight);
        } else {
            i6 = layoutChildLeft(this.mLogoView, i5, iArr, minimumHeight);
            i7 = i8;
        }
        ...
        for (measuredWidth = 0; measuredWidth < i6; measuredWidth++) {
            i7 = layoutChildRight((View) this.mTempViews.get(measuredWidth), i7, iArr, minimumHeight);
        }
        ...
        while (measuredWidth < paddingLeft) {
            i8 = layoutChildLeft((View) this.mTempViews.get(measuredWidth), i5, iArr, minimumHeight);
            measuredWidth++;
            i5 = i8;
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i3 < i4) {
            ...
            if (((LayoutParams) childAt.getLayoutParams()).mViewType == 0 && shouldLayout(childAt)) {
                ...
                i5 = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(childAt));
        ...
        if (shouldLayout(this.mTitleTextView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(this.mTitleTextView));
        }
        ...
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
        measuredWidth = ViewCompat.resolveSizeAndState(Math.max((i5 + max2) + (measuredWidth + paddingRight), getSuggestedMinimumWidth()), i, ViewCompat.MEASURED_STATE_MASK & combineMeasuredStates);
        i5 = ViewCompat.resolveSizeAndState(Math.max((paddingTop + paddingBottom) + contentInsetStart, getSuggestedMinimumHeight()), i2, combineMeasuredStates << 16);
        if (shouldCollapse()) {
            i5 = 0;
        }

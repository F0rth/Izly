...
public final class MultiDex {
    ...
    L_0x0018:
        ...
        throw r0;
    L_0x003b:
        r0 = getApplicationInfo(r6);	 Catch:{ Exception -> 0x0053 }
        if (r0 == 0) goto L_0x0012;
    L_0x0041:
        r1 = installedApk;	 Catch:{ Exception -> 0x0053 }
        monitor-enter(r1);	 Catch:{ Exception -> 0x0053 }
        r2 = r0.sourceDir;	 Catch:{ all -> 0x0050 }
        r3 = installedApk;	 Catch:{ all -> 0x0050 }
        r3 = r3.contains(r2);	 Catch:{ all -> 0x0050 }
    ...
    L_0x007a:
        r3 = installedApk;	 Catch:{ all -> 0x0050 }
        r3.add(r2);	 Catch:{ all -> 0x0050 }
        r2 = android.os.Build.VERSION.SDK_INT;	 Catch:{ all -> 0x0050 }
        r3 = 20;
    ...
    L_0x0085:
        ...
        r4 = android.os.Build.VERSION.SDK_INT;	 Catch:{ all -> 0x0050 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x0050 }
        r4 = ": SDK version higher than 20";
        r3 = r3.append(r4);	 Catch:{ all -> 0x0050 }
        r4 = " should be backed by runtime with built-in multidex capabilty but it's not the ";
        r3 = r3.append(r4);	 Catch:{ all -> 0x0050 }
        r4 = "case here: java.vm.version=\"";
        r3 = r3.append(r4);	 Catch:{ all -> 0x0050 }
        r4 = "java.vm.version";
        r4 = java.lang.System.getProperty(r4);	 Catch:{ all -> 0x0050 }
        r3 = r3.append(r4);	 Catch:{ all -> 0x0050 }
        r4 = "\"";
        r3 = r3.append(r4);	 Catch:{ all -> 0x0050 }
        r3 = r3.toString();	 Catch:{ all -> 0x0050 }
        android.util.Log.w(r2, r3);	 Catch:{ all -> 0x0050 }
    L_0x00bd:
        r2 = r6.getClassLoader();	 Catch:{ RuntimeException -> 0x00cd }
        if (r2 != 0) goto L_0x00d8;
    L_0x00c3:
        r0 = "MultiDex";
        r2 = "Context class loader is null. Must be running in test mode. Skip patching.";
        android.util.Log.e(r0, r2);	 Catch:{ all -> 0x0050 }
        monitor-exit(r1);	 Catch:{ all -> 0x0050 }
        goto L_0x0012;
    L_0x00cd:
        r0 = move-exception;
        ...
        android.util.Log.w(r2, r3, r0);	 Catch:{ all -> 0x0050 }
        monitor-exit(r1);	 Catch:{ all -> 0x0050 }
        goto L_0x0012;
    L_0x00d8:
        clearOldDexDir(r6);	 Catch:{ Throwable -> 0x00fc }
    L_0x00db:
        r3 = new java.io.File;	 Catch:{ all -> 0x0050 }
        r4 = r0.dataDir;	 Catch:{ all -> 0x0050 }
        r5 = SECONDARY_FOLDER_NAME;	 Catch:{ all -> 0x0050 }
        r3.<init>(r4, r5);	 Catch:{ all -> 0x0050 }
        r4 = 0;
        r4 = android.support.multidex.MultiDexExtractor.load(r6, r0, r3, r4);	 Catch:{ all -> 0x0050 }
        r5 = checkValidZipFiles(r4);	 Catch:{ all -> 0x0050 }
        if (r5 == 0) goto L_0x0105;
    L_0x00ef:
        installSecondaryDexes(r2, r3, r4);	 Catch:{ all -> 0x0050 }
    L_0x00f2:
        monitor-exit(r1);	 Catch:{ all -> 0x0050 }
        r0 = "MultiDex";
        r1 = "install done";
    ...
    L_0x00fc:
        ...
        android.util.Log.w(r4, r5, r3);	 Catch:{ all -> 0x0050 }
        goto L_0x00db;
    L_0x0105:
        r4 = "MultiDex";
        r5 = "Files were not valid zip files.  Forcing a reload.";
        android.util.Log.w(r4, r5);	 Catch:{ all -> 0x0050 }
        r4 = 1;
        r0 = android.support.multidex.MultiDexExtractor.load(r6, r0, r3, r4);	 Catch:{ all -> 0x0050 }
        r4 = checkValidZipFiles(r0);	 Catch:{ all -> 0x0050 }
        if (r4 == 0) goto L_0x011b;
    L_0x0117:
        installSecondaryDexes(r2, r3, r0);	 Catch:{ all -> 0x0050 }
        goto L_0x00f2;
    L_0x011b:

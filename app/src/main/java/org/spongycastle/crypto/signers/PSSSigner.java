...
public class PSSSigner implements Signer {
    ...
    private byte[] maskGeneratorFunction1(byte[] bArr, int i, int i2, int i3) {
        ...
        while (i4 < i3 / this.mgfhLen) {
            ...
            this.mgfDigest.update(bArr2, 0, 4);
        ...
        if (this.mgfhLen * i4 < i3) {
            ...
            this.mgfDigest.update(bArr2, 0, 4);
            this.mgfDigest.doFinal(obj2, 0);
            System.arraycopy(obj2, 0, obj, this.mgfhLen * i4, i3 - (i4 * this.mgfhLen));
        }
        return obj;
    }
    ...
    public byte[] generateSignature() throws CryptoException, DataLengthException {
        ...
        bArr2[0] = (byte) (bArr2[0] & (CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV >> ((this.block.length * 8) - this.emBits)));
    ...
    public boolean verifySignature(byte[] bArr) {
        ...
        try {
            ...
            bArr3[0] = (byte) (bArr3[0] & (CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV >> ((this.block.length * 8) - this.emBits)));
            ...
            for (int length = this.mDash.length - this.hLen; length != this.mDash.length; length++) {
                if ((this.block[i] ^ this.mDash[length]) != 0) {

...
public class CamelliaLightEngine implements BlockCipher {
    ...
    private void camelliaF2(int[] iArr, int[] iArr2, int i) {
        ...
        byte b = SBOX1[(i2 >>> 24) & 255];
        int i3 = iArr[1] ^ iArr2[i + 1];
        i3 = leftRotate((sbox2((i3 >>> 24) & 255) << 24) | (((SBOX1[i3 & 255] & 255) | (sbox4((i3 >>> 8) & 255) << 8)) | (sbox3((i3 >>> 16) & 255) << 16)), 8);
        i2 = (((b & 255) << 24) | ((sbox4 | (sbox3 << 8)) | (sbox2 << 16))) ^ i3;
        sbox4 = leftRotate(i3, 8) ^ i2;
        i2 = rightRotate(i2, 8) ^ sbox4;
        iArr[2] = (leftRotate(sbox4, 16) ^ i2) ^ iArr[2];
        iArr[3] = leftRotate(i2, 8) ^ iArr[3];
        i2 = iArr[2] ^ iArr2[i + 2];
        sbox4 = sbox4(i2 & 255);
        sbox3 = sbox3((i2 >>> 8) & 255);
        sbox2 = sbox2((i2 >>> 16) & 255);
        b = SBOX1[(i2 >>> 24) & 255];
        i3 = iArr[3] ^ iArr2[i + 3];
        i3 = leftRotate((sbox2((i3 >>> 24) & 255) << 24) | (((SBOX1[i3 & 255] & 255) | (sbox4((i3 >>> 8) & 255) << 8)) | (sbox3((i3 >>> 16) & 255) << 16)), 8);
        i2 = (((b & 255) << 24) | ((sbox4 | (sbox3 << 8)) | (sbox2 << 16))) ^ i3;
        sbox4 = leftRotate(i3, 8) ^ i2;
        i2 = rightRotate(i2, 8) ^ sbox4;
        iArr[0] = (leftRotate(sbox4, 16) ^ i2) ^ iArr[0];

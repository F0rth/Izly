...
public class NaccacheSternEngine implements AsymmetricBlockCipher {
    ...
    private static BigInteger chineseRemainder(Vector vector, Vector vector2) {
        ...
        while (i2 < vector2.size()) {
            BigInteger multiply = bigInteger2.multiply((BigInteger) vector2.elementAt(i2));
            i2++;
            bigInteger2 = multiply;
        }
        BigInteger bigInteger3 = bigInteger;
        while (i < vector2.size()) {
            multiply = (BigInteger) vector2.elementAt(i);
            bigInteger = bigInteger2.divide(multiply);
            i++;
            bigInteger3 = bigInteger3.add(bigInteger.multiply(bigInteger.modInverse(multiply)).multiply((BigInteger) vector.elementAt(i)));
        }

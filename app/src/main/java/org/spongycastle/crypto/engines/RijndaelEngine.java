...
public class RijndaelEngine implements BlockCipher {
    ...
    static {
        byte[] bArr = new byte[]{(byte) 0, (byte) 32, (byte) 24, Tnaf.POW_2_WIDTH};
        byte[] bArr2 = new byte[]{(byte) 0, (byte) 48, (byte) 40, (byte) 24};
        shifts1 = new byte[][]{new byte[]{(byte) 0, (byte) 24, Tnaf.POW_2_WIDTH, (byte) 8}, bArr, new byte[]{(byte) 0, (byte) 40, (byte) 32, (byte) 24}, bArr2, new byte[]{(byte) 0, (byte) 56, (byte) 40, (byte) 32}};
    }
    ...
    private void InvMixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            int i6 = i2 != 0 ? logtable[i2 & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV : -1;
            int i7 = i3 != 0 ? logtable[i3 & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV : -1;
            i3 = i4 != 0 ? logtable[i4 & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV : -1;
            i2 = i5 != 0 ? logtable[i5 & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV : -1;
            j4 |= ((long) ((((mul0xe(i6) ^ mul0xb(i7)) ^ mul0xd(i3)) ^ mul0x9(i2)) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i;
            j3 |= ((long) ((((mul0xe(i7) ^ mul0xb(i3)) ^ mul0xd(i2)) ^ mul0x9(i6)) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i;
            j2 |= ((long) ((((mul0xe(i3) ^ mul0xb(i2)) ^ mul0xd(i6)) ^ mul0x9(i7)) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i;
            j |= ((long) ((((mul0xe(i2) ^ mul0xb(i6)) ^ mul0xd(i7)) ^ mul0x9(i3)) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i;
        }
        this.A0 = j4;
        this.A1 = j3;
        this.A2 = j2;
    ...
    private void MixColumn() {
        ...
        for (int i = 0; i < this.BC; i += 8) {
            ...
            int i4 = (int) ((this.A2 >> i) & 255);
            int i5 = (int) ((this.A3 >> i) & 255);
            j4 |= ((long) ((((mul0x2(i2) ^ mul0x3(i3)) ^ i4) ^ i5) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i;
            j3 |= ((long) ((((mul0x2(i3) ^ mul0x3(i4)) ^ i5) ^ i2) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i;
            j2 |= ((long) ((((mul0x2(i4) ^ mul0x3(i5)) ^ i2) ^ i3) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i;
            j |= ((long) ((((mul0x3(i2) ^ mul0x2(i5)) ^ i3) ^ i4) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i;
        }
        this.A0 = j4;
        this.A1 = j3;
        this.A2 = j2;
    ...
    private long applyS(long j, byte[] bArr) {
        long j2 = 0;
        for (int i = 0; i < this.BC; i += 8) {
            j2 |= ((long) (bArr[(int) ((j >> i) & 255)] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i;
        }
        return j2;
    }
    ...
    private long[][] generateWorkingKey(byte[] bArr) {
        ...
        i3 = 0;
        for (length = 0; length < i && i3 < (this.ROUNDS + 1) * (this.BC / 8); length++) {
            for (i2 = 0; i2 < 4; i2++) {
                long[] jArr2 = jArr[i3 / (this.BC / 8)];
                jArr2[i2] = jArr2[i2] | (((long) (bArr2[i2][length] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << ((i3 * 8) % this.BC));
            }
            i3++;
        }
        length = 0;
        while (i3 < (this.ROUNDS + 1) * (this.BC / 8)) {
            int i4;
            for (i2 = 0; i2 < 4; i2++) {
                byte[] bArr3 = bArr2[i2];
                bArr3[0] = (byte) (bArr3[0] ^ S[bArr2[(i2 + 1) % 4][i - 1] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV]);
            }
            byte[] bArr4 = bArr2[0];
            bArr4[0] = (byte) (bArr4[0] ^ rcon[length]);
            byte[] bArr5;
            if (i <= 6) {
                for (i4 = 1; i4 < i; i4++) {
                    for (i2 = 0; i2 < 4; i2++) {
                        bArr5 = bArr2[i2];
                        bArr5[i4] = (byte) (bArr5[i4] ^ bArr2[i2][i4 - 1]);
                    }
                }
            } else {
                for (i4 = 1; i4 < 4; i4++) {
                ...
                for (i2 = 0; i2 < 4; i2++) {
                    bArr3 = bArr2[i2];
                    bArr3[4] = (byte) (bArr3[4] ^ S[bArr2[i2][3] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV]);
                }
                for (i4 = 5; i4 < i; i4++) {
                    for (i2 = 0; i2 < 4; i2++) {
                        bArr5 = bArr2[i2];
            ...
            i2 = 0;
            while (i2 < i && i3 < (this.ROUNDS + 1) * (this.BC / 8)) {
                for (i4 = 0; i4 < 4; i4++) {
                    long[] jArr3 = jArr[i3 / (this.BC / 8)];
                    jArr3[i4] = jArr3[i4] | (((long) (bArr2[i4][i2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << ((i3 * 8) % this.BC));
                }
                i2++;
                i3++;
            }
    ...
    private byte mul0x2(int i) {
        return i != 0 ? aLogtable[(logtable[i] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) + 25] : (byte) 0;
    }

    private byte mul0x3(int i) {
        return i != 0 ? aLogtable[(logtable[i] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) + 1] : (byte) 0;
    }
    ...
    private void unpackBlock(byte[] bArr, int i) {
        int i2 = i + 1;
        this.A0 = (long) (bArr[i] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV);
        int i3 = i2 + 1;
        this.A1 = (long) (bArr[i2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV);
        int i4 = i3 + 1;
        this.A2 = (long) (bArr[i3] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV);
        i2 = i4 + 1;
        this.A3 = (long) (bArr[i4] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV);
        for (i3 = 8; i3 != this.BC; i3 += 8) {
            int i5 = i2 + 1;
            this.A0 |= ((long) (bArr[i2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i3;
            i2 = i5 + 1;
            this.A1 |= ((long) (bArr[i5] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i3;
            i5 = i2 + 1;
            this.A2 |= ((long) (bArr[i2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i3;
            i2 = i5 + 1;
            this.A3 |= ((long) (bArr[i5] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV)) << i3;
        }
    }

...
public final class TwofishEngine implements BlockCipher {
    ...
    public TwofishEngine() {
        ...
        int[] iArr3 = new int[2];
        for (int i = 0; i < 256; i++) {
            int i2 = P[0][i] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
            iArr[0] = i2;
            iArr2[0] = Mx_X(i2) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
            iArr3[0] = Mx_Y(i2) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
            i2 = P[1][i] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
            iArr[1] = i2;
            iArr2[1] = Mx_X(i2) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
            iArr3[1] = Mx_Y(i2) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
    ...
    private int F32(int i, int[] iArr) {
        ...
        switch (this.k64Cnt & 3) {
            case 0:
                b0 = (P[1][b0] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(i5);
                b1 = (P[0][b1] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(i5);
                b2 = (P[0][b2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(i5);
                b3 = (P[1][b3] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(i5);
                break;
            case 1:
                return ((this.gMDS0[(P[0][b0] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(i2)] ^ this.gMDS1[(P[0][b1] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(i2)]) ^ this.gMDS2[(P[1][b2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(i2)]) ^ this.gMDS3[(P[1][b3] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(i2)];
            case 2:
                break;
            case 3:
                break;
        ...
        b0 = (P[1][b0] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(i4);
        b1 = (P[1][b1] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(i4);
        b2 = (P[0][b2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(i4);
        b3 = (P[0][b3] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(i4);
        return ((this.gMDS0[(P[0][(P[0][b0] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(i3)] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(i2)] ^ this.gMDS1[(P[0][(P[1][b1] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(i3)] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(i2)]) ^ this.gMDS2[(P[1][(P[0][b2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(i3)] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(i2)]) ^ this.gMDS3[(P[1][(P[1][b3] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(i3)] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(i2)];
    }

    private int Fe32_0(int i) {
        return ((this.gSBox[((i & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) * 2) + 0] ^ this.gSBox[(((i >>> 8) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) * 2) + 1]) ^ this.gSBox[(((i >>> 16) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) * 2) + 512]) ^ this.gSBox[(((i >>> 24) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) * 2) + 513];
    }

    private int Fe32_3(int i) {
        return ((this.gSBox[(((i >>> 24) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) * 2) + 0] ^ this.gSBox[((i & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) * 2) + 1]) ^ this.gSBox[(((i >>> 8) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) * 2) + 512]) ^ this.gSBox[(((i >>> 16) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) * 2) + 513];
    }
    ...
    private int RS_rem(int i) {
        int i2 = 0;
        int i3 = (i >>> 24) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
        int i4 = (((i3 & 128) != 0 ? RS_GF_FDBK : 0) ^ (i3 << 1)) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
        if ((i3 & 1) != 0) {
            i2 = 166;
        }
        i2 = (i2 ^ (i3 >>> 1)) ^ i4;
        return ((((i2 << 24) ^ (i << 8)) ^ (i4 << 16)) ^ (i2 << 8)) ^ i3;
    }

    private int b0(int i) {
        return i & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
    }

    private int b1(int i) {
        return (i >>> 8) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
    }

    private int b2(int i) {
        return (i >>> 16) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
    }

    private int b3(int i) {
        return (i >>> 24) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
    }
    ...
    private void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int BytesTo32Bits3 = this.gSubKeys[6] ^ BytesTo32Bits(bArr, i + 8);
        ...
        for (int i4 = 0; i4 < 16; i4 += 2) {
            ...
            int i5 = i3 - 1;
            BytesTo32Bits4 ^= this.gSubKeys[i3] + ((Fe32_3 * 2) + Fe32_0);
            int i6 = i5 - 1;
            BytesTo32Bits3 = ((BytesTo32Bits3 << 1) | (BytesTo32Bits3 >>> 31)) ^ (this.gSubKeys[i5] + (Fe32_0 + Fe32_3));
            BytesTo32Bits4 = (BytesTo32Bits4 << 31) | (BytesTo32Bits4 >>> 1);
            Fe32_0 = Fe32_0(BytesTo32Bits3);
            Fe32_3 = Fe32_3(BytesTo32Bits4);
            i5 = i6 - 1;
            BytesTo32Bits2 ^= this.gSubKeys[i6] + ((Fe32_3 * 2) + Fe32_0);
            i3 = i5 - 1;
            BytesTo32Bits = ((BytesTo32Bits << 1) | (BytesTo32Bits >>> 31)) ^ ((Fe32_0 + Fe32_3) + this.gSubKeys[i5]);
            BytesTo32Bits2 = (BytesTo32Bits2 >>> 1) | (BytesTo32Bits2 << 31);
        }
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int BytesTo32Bits2 = this.gSubKeys[1] ^ BytesTo32Bits(bArr, i + 4);
        int BytesTo32Bits3 = this.gSubKeys[2] ^ BytesTo32Bits(bArr, i + 8);
        ...
        while (i3 < 16) {
            ...
            BytesTo32Bits3 = (i4 << 31) | (i4 >>> 1);
            int i6 = i5 + 1;
            BytesTo32Bits4 = ((BytesTo32Bits4 >>> 31) | (BytesTo32Bits4 << 1)) ^ (this.gSubKeys[i5] + (Fe32_0 + (Fe32_3 * 2)));
            Fe32_0 = Fe32_0(BytesTo32Bits3);
            Fe32_3 = Fe32_3(BytesTo32Bits4);
            i5 = i6 + 1;
            i4 = (this.gSubKeys[i6] + (Fe32_0 + Fe32_3)) ^ BytesTo32Bits;
            BytesTo32Bits = (i4 << 31) | (i4 >>> 1);
            i4 = i5 + 1;
            BytesTo32Bits2 = ((BytesTo32Bits2 << 1) | (BytesTo32Bits2 >>> 31)) ^ ((Fe32_0 + (Fe32_3 * 2)) + this.gSubKeys[i5]);
            i3 += 2;
        }
    ...
    private void setKey(byte[] bArr) {
        ...
        if (this.k64Cnt <= 0) {
            ...
            for (i = 0; i < 20; i++) {
                ...
                i2 += F32;
                this.gSubKeys[(i * 2) + 1] = (i2 << 9) | (i2 >>> 23);
            }
            F32 = iArr3[0];
            int i3 = iArr3[1];
            int i4 = iArr3[2];
            int i5 = iArr3[3];
            this.gSBox = new int[PKIFailureInfo.badRecipientNonce];
            for (int i6 = 0; i6 < 256; i6++) {
                int b1;
                int b2;
                switch (this.k64Cnt & 3) {
                    case 0:
                        i = (P[1][i6] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(i5);
                        b1 = (P[0][i6] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(i5);
                        b2 = (P[0][i6] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(i5);
                        i2 = (P[1][i6] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(i5);
                        break;
                    case 1:
                        this.gSBox[i6 * 2] = this.gMDS0[(P[0][i6] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(F32)];
                        this.gSBox[(i6 * 2) + 1] = this.gMDS1[(P[0][i6] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(F32)];
                        this.gSBox[(i6 * 2) + 512] = this.gMDS2[(P[1][i6] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(F32)];
                        this.gSBox[(i6 * 2) + 513] = this.gMDS3[(P[1][i6] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(F32)];
                        continue;
                    case 2:
                        i = i6;
                        b1 = i6;
                ...
                i = (P[1][i] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(i4);
                b1 = (P[1][b1] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(i4);
                b2 = (P[0][b2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(i4);
                i2 = (P[0][i2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(i4);
                this.gSBox[i6 * 2] = this.gMDS0[(P[0][(P[0][i] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(i3)] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b0(F32)];
                this.gSBox[(i6 * 2) + 1] = this.gMDS1[(P[0][(P[1][b1] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(i3)] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b1(F32)];
                this.gSBox[(i6 * 2) + 512] = this.gMDS2[(P[1][(P[0][b2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(i3)] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b2(F32)];
                this.gSBox[(i6 * 2) + 513] = this.gMDS3[(P[1][(P[1][i2] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(i3)] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV) ^ b3(F32)];
            }
        }
    }

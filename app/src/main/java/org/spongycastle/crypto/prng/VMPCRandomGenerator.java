...
public class VMPCRandomGenerator implements RandomGenerator {
    ...
    public void addSeedMaterial(long j) {
        byte b = (byte) ((int) (255 & j));
        byte b2 = (byte) ((int) ((65280 & j) >> 8));
        byte b3 = (byte) ((int) ((16711680 & j) >> 16));
        addSeedMaterial(new byte[]{(byte) ((int) ((-16777216 & j) >> 24)), b3, b2, b});
    }

    public void addSeedMaterial(byte[] bArr) {
        for (byte b : bArr) {
            this.s = this.P[((this.s + this.P[this.n & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV]) + b) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV];
    ...
    public void nextBytes(byte[] bArr, int i, int i2) {
        synchronized (this.P) {
            for (int i3 = i; i3 != i + i2; i3++) {
                ...
                bArr[i3] = this.P[(this.P[this.P[this.s & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV] & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV] + 1) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV];

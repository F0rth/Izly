...
public class BufferedBlockCipher {
    ...
    public BufferedBlockCipher(BlockCipher blockCipher) {
        ...
        this.pgpCFB = z2;
        if (!this.pgpCFB && (indexOf <= 0 || !(algorithmName.startsWith("CFB", indexOf) || algorithmName.startsWith("OFB", indexOf) || algorithmName.startsWith("OpenPGP", indexOf) || algorithmName.startsWith("SIC", indexOf) || algorithmName.startsWith("GCTR", indexOf)))) {
            z = false;
        }

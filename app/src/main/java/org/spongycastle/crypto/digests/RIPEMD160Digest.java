...
public class RIPEMD160Digest extends GeneralDigest {
    ...
    protected void processBlock() {
        ...
        i2 = RL(i2, 10);
        RL5 = RL(((RL5 + f3(RL3, RL, RL4)) + this.X[3]) + 1859775393, 11) + RL2;
        RL = RL(RL, 10);
        RL2 = RL(((RL2 + f3(RL5, RL3, RL)) + this.X[10]) + 1859775393, 13) + RL4;
        RL3 = RL(RL3, 10);
        RL4 = RL(((RL4 + f3(RL2, RL5, RL3)) + this.X[14]) + 1859775393, 6) + RL;
        RL5 = RL(RL5, 10);
        RL = RL(((RL + f3(RL4, RL2, RL5)) + this.X[4]) + 1859775393, 7) + RL3;
        RL2 = RL(RL2, 10);
        RL3 = RL(((RL3 + f3(RL, RL4, RL2)) + this.X[9]) + 1859775393, 14) + RL5;
        RL4 = RL(RL4, 10);
        RL5 = RL(((RL5 + f3(RL3, RL, RL4)) + this.X[15]) + 1859775393, 9) + RL2;
        RL = RL(RL, 10);
        RL2 = RL(((RL2 + f3(RL5, RL3, RL)) + this.X[8]) + 1859775393, 13) + RL4;
        RL3 = RL(RL3, 10);
        RL4 = RL(((RL4 + f3(RL2, RL5, RL3)) + this.X[1]) + 1859775393, 15) + RL;
        RL5 = RL(RL5, 10);
        RL = RL(((RL + f3(RL4, RL2, RL5)) + this.X[2]) + 1859775393, 14) + RL3;
        RL2 = RL(RL2, 10);
        RL3 = RL(((RL3 + f3(RL, RL4, RL2)) + this.X[7]) + 1859775393, 8) + RL5;
        RL4 = RL(RL4, 10);
        RL5 = RL(((RL5 + f3(RL3, RL, RL4)) + this.X[0]) + 1859775393, 13) + RL2;
        RL = RL(RL, 10);
        RL2 = RL(((RL2 + f3(RL5, RL3, RL)) + this.X[6]) + 1859775393, 6) + RL4;
        RL3 = RL(RL3, 10);
        RL4 = RL(((RL4 + f3(RL2, RL5, RL3)) + this.X[13]) + 1859775393, 5) + RL;
        RL5 = RL(RL5, 10);
        RL = RL(((RL + f3(RL4, RL2, RL5)) + this.X[11]) + 1859775393, 12) + RL3;
        RL2 = RL(RL2, 10);
        RL3 = RL(((RL3 + f3(RL, RL4, RL2)) + this.X[5]) + 1859775393, 7) + RL5;
        RL4 = RL(RL4, 10);
        RL5 = RL(((RL5 + f3(RL3, RL, RL4)) + this.X[12]) + 1859775393, 5) + RL2;
        RL = RL(RL, 10);
        ...
        i = RL(i, 10);
        RL2 = RL(((RL2 + f4(RL5, RL3, RL)) + this.X[1]) - 1894007588, 11) + RL4;
        RL3 = RL(RL3, 10);
        RL4 = RL(((RL4 + f4(RL2, RL5, RL3)) + this.X[9]) - 1894007588, 12) + RL;
        RL5 = RL(RL5, 10);
        RL = RL(((RL + f4(RL4, RL2, RL5)) + this.X[11]) - 1894007588, 14) + RL3;
        RL2 = RL(RL2, 10);
        RL3 = RL(((RL3 + f4(RL, RL4, RL2)) + this.X[10]) - 1894007588, 15) + RL5;
        RL4 = RL(RL4, 10);
        RL5 = RL(((RL5 + f4(RL3, RL, RL4)) + this.X[0]) - 1894007588, 14) + RL2;
        RL = RL(RL, 10);
        RL2 = RL(((RL2 + f4(RL5, RL3, RL)) + this.X[8]) - 1894007588, 15) + RL4;
        RL3 = RL(RL3, 10);
        RL4 = RL(((RL4 + f4(RL2, RL5, RL3)) + this.X[12]) - 1894007588, 9) + RL;
        RL5 = RL(RL5, 10);
        RL = RL(((RL + f4(RL4, RL2, RL5)) + this.X[4]) - 1894007588, 8) + RL3;
        RL2 = RL(RL2, 10);
        RL3 = RL(((RL3 + f4(RL, RL4, RL2)) + this.X[13]) - 1894007588, 9) + RL5;
        RL4 = RL(RL4, 10);
        RL5 = RL(((RL5 + f4(RL3, RL, RL4)) + this.X[3]) - 1894007588, 14) + RL2;
        RL = RL(RL, 10);
        RL2 = RL(((RL2 + f4(RL5, RL3, RL)) + this.X[7]) - 1894007588, 5) + RL4;
        RL3 = RL(RL3, 10);
        RL4 = RL(((RL4 + f4(RL2, RL5, RL3)) + this.X[15]) - 1894007588, 6) + RL;
        RL5 = RL(RL5, 10);
        RL = RL(((RL + f4(RL4, RL2, RL5)) + this.X[14]) - 1894007588, 8) + RL3;
        RL2 = RL(RL2, 10);
        RL3 = RL(((RL3 + f4(RL, RL4, RL2)) + this.X[5]) - 1894007588, 6) + RL5;
        RL4 = RL(RL4, 10);
        RL5 = RL(((RL5 + f4(RL3, RL, RL4)) + this.X[6]) - 1894007588, 5) + RL2;
        RL = RL(RL, 10);
        RL2 = RL(((RL2 + f4(RL5, RL3, RL)) + this.X[2]) - 1894007588, 12) + RL4;
        RL3 = RL(RL3, 10);
        ...
        i5 = RL(i5, 10);
        RL4 = RL(((RL4 + f5(RL2, RL5, RL3)) + this.X[4]) - 1454113458, 9) + RL;
        RL5 = RL(RL5, 10);
        RL = RL(((RL + f5(RL4, RL2, RL5)) + this.X[0]) - 1454113458, 15) + RL3;
        RL2 = RL(RL2, 10);
        RL3 = RL(((RL3 + f5(RL, RL4, RL2)) + this.X[5]) - 1454113458, 5) + RL5;
        RL4 = RL(RL4, 10);
        RL5 = RL(((RL5 + f5(RL3, RL, RL4)) + this.X[9]) - 1454113458, 11) + RL2;
        RL = RL(RL, 10);
        RL2 = RL(((RL2 + f5(RL5, RL3, RL)) + this.X[7]) - 1454113458, 6) + RL4;
        RL3 = RL(RL3, 10);
        RL4 = RL(((RL4 + f5(RL2, RL5, RL3)) + this.X[12]) - 1454113458, 8) + RL;
        RL5 = RL(RL5, 10);
        RL = RL(((RL + f5(RL4, RL2, RL5)) + this.X[2]) - 1454113458, 13) + RL3;
        RL2 = RL(RL2, 10);
        RL3 = RL(((RL3 + f5(RL, RL4, RL2)) + this.X[10]) - 1454113458, 12) + RL5;
        RL4 = RL(RL4, 10);
        RL5 = RL(((RL5 + f5(RL3, RL, RL4)) + this.X[14]) - 1454113458, 5) + RL2;
        RL = RL(RL, 10);
        RL2 = RL(((RL2 + f5(RL5, RL3, RL)) + this.X[1]) - 1454113458, 12) + RL4;
        RL3 = RL(RL3, 10);
        RL4 = RL(((RL4 + f5(RL2, RL5, RL3)) + this.X[3]) - 1454113458, 13) + RL;
        RL5 = RL(RL5, 10);
        RL = RL(((RL + f5(RL4, RL2, RL5)) + this.X[8]) - 1454113458, 14) + RL3;
        RL2 = RL(RL2, 10);
        RL3 = RL(((RL3 + f5(RL, RL4, RL2)) + this.X[11]) - 1454113458, 11) + RL5;
        RL4 = RL(RL4, 10);
        RL5 = RL(((RL5 + f5(RL3, RL, RL4)) + this.X[6]) - 1454113458, 8) + RL2;
        RL = RL(RL, 10);
        RL2 = RL(((RL2 + f5(RL5, RL3, RL)) + this.X[15]) - 1454113458, 5) + RL4;
        RL3 = RL(RL3, 10);
        RL4 = RL(((RL4 + f5(RL2, RL5, RL3)) + this.X[13]) - 1454113458, 6);
        RL5 = RL(RL5, 10);
        ...
        i5 = RL(i5, 10);
        i2 = RL((i2 + f1(i3, i4, i5)) + this.X[11], 11);
        i4 = RL(i4, 10);
        int i6 = this.H1;
        this.H1 = i5 + (RL5 + this.H2);
        this.H2 = (this.H3 + RL3) + i;
        this.H3 = (i + i2) + (this.H4 + RL);
        this.H4 = (this.H0 + (RL4 + RL)) + i3;
        this.H0 = (RL2 + i6) + i4;
        this.xOff = 0;

...
public class NTRUEncryptionKeyGenerationParameters extends KeyGenerationParameters implements Cloneable {
    public static final NTRUEncryptionKeyGenerationParameters APR2011_439 = new NTRUEncryptionKeyGenerationParameters(439, PKIFailureInfo.wrongIntegrity, CipherSuite.TLS_RSA_PSK_WITH_RC4_128_SHA, Wbxml.EXT_T_2, 128, 9, 32, 9, true, new byte[]{(byte) 0, (byte) 7, (byte) 101}, true, false, new SHA256Digest());
    public static final NTRUEncryptionKeyGenerationParameters APR2011_439_FAST = new NTRUEncryptionKeyGenerationParameters(439, PKIFailureInfo.wrongIntegrity, 9, 8, 5, Wbxml.EXT_T_2, 128, 9, 32, 9, true, new byte[]{(byte) 0, (byte) 7, (byte) 101}, true, true, new SHA256Digest());
    public static final NTRUEncryptionKeyGenerationParameters APR2011_743 = new NTRUEncryptionKeyGenerationParameters(743, PKIFailureInfo.wrongIntegrity, 248, 220, 256, 10, 27, 14, true, new byte[]{(byte) 0, (byte) 7, (byte) 105}, false, false, new SHA512Digest());
    public static final NTRUEncryptionKeyGenerationParameters APR2011_743_FAST = new NTRUEncryptionKeyGenerationParameters(743, PKIFailureInfo.wrongIntegrity, 11, 11, 15, 220, 256, 10, 27, 14, true, new byte[]{(byte) 0, (byte) 7, (byte) 105}, false, true, new SHA512Digest());
    public static final NTRUEncryptionKeyGenerationParameters EES1087EP2 = new NTRUEncryptionKeyGenerationParameters(1087, PKIFailureInfo.wrongIntegrity, 120, 120, 256, 13, 25, 14, true, new byte[]{(byte) 0, (byte) 6, (byte) 3}, true, false, new SHA512Digest());
    public static final NTRUEncryptionKeyGenerationParameters EES1171EP1 = new NTRUEncryptionKeyGenerationParameters(1171, PKIFailureInfo.wrongIntegrity, 106, 106, 256, 13, 20, 15, true, new byte[]{(byte) 0, (byte) 6, (byte) 4}, true, false, new SHA512Digest());
    public static final NTRUEncryptionKeyGenerationParameters EES1499EP1 = new NTRUEncryptionKeyGenerationParameters(1499, PKIFailureInfo.wrongIntegrity, 79, 79, 256, 13, 17, 19, true, new byte[]{(byte) 0, (byte) 6, (byte) 5}, true, false, new SHA512Digest());
    public int N;
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            ...
            if (this.hashSeed != nTRUEncryptionKeyGenerationParameters.hashSeed || this.llen != nTRUEncryptionKeyGenerationParameters.llen || this.maxMsgLenBytes != nTRUEncryptionKeyGenerationParameters.maxMsgLenBytes || this.minCallsMask != nTRUEncryptionKeyGenerationParameters.minCallsMask || this.minCallsR != nTRUEncryptionKeyGenerationParameters.minCallsR || !Arrays.equals(this.oid, nTRUEncryptionKeyGenerationParameters.oid) || this.pkLen != nTRUEncryptionKeyGenerationParameters.pkLen || this.polyType != nTRUEncryptionKeyGenerationParameters.polyType || this.q != nTRUEncryptionKeyGenerationParameters.q) {
                return false;
            }
            if (this.sparse != nTRUEncryptionKeyGenerationParameters.sparse) {
                return false;
            }
        }
        return true;

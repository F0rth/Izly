...
public interface PKCSObjectIdentifiers {
    public static final ASN1ObjectIdentifier RC2_CBC = encryptionAlgorithm.branch(BuildConfig.VERSION_NAME);
    ...
    public static final ASN1ObjectIdentifier id_cti_ets_proofOfReceipt = id_cti.branch(BuildConfig.VERSION_NAME);
    ...
    public static final ASN1ObjectIdentifier md2WithRSAEncryption = pkcs_1.branch(BuildConfig.VERSION_NAME);
    ...
    public static final ASN1ObjectIdentifier pbeWithSHAAnd40BitRC4 = pkcs_12PbeIds.branch(BuildConfig.VERSION_NAME);
    public static final ASN1ObjectIdentifier pbewithSHAAnd40BitRC2_CBC = pkcs_12PbeIds.branch("6");
    public static final ASN1ObjectIdentifier pkcs8ShroudedKeyBag = bagtypes.branch(BuildConfig.VERSION_NAME);
    ...
    public static final ASN1ObjectIdentifier pkcs_9_at_unstructuredName = pkcs_9.branch(BuildConfig.VERSION_NAME);
    ...
    public static final ASN1ObjectIdentifier sdsiCertificate = certTypes.branch(BuildConfig.VERSION_NAME);
    ...
    static {
        ...
        pkcs_3 = aSN1ObjectIdentifier;
        dhKeyAgreement = aSN1ObjectIdentifier.branch("1");
        aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.5");
        pkcs_5 = aSN1ObjectIdentifier;
        pbeWithMD2AndDES_CBC = aSN1ObjectIdentifier.branch("1");
        aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.3");
        encryptionAlgorithm = aSN1ObjectIdentifier;
        des_EDE3_CBC = aSN1ObjectIdentifier.branch("7");
        aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.2");
        digestAlgorithm = aSN1ObjectIdentifier;
        md2 = aSN1ObjectIdentifier.branch(BuildConfig.VERSION_NAME);
        aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.9");
        pkcs_9 = aSN1ObjectIdentifier;
        pkcs_9_at_emailAddress = aSN1ObjectIdentifier.branch("1");
        aSN1ObjectIdentifier = pkcs_9.branch("22");
        certTypes = aSN1ObjectIdentifier;
        x509Certificate = aSN1ObjectIdentifier.branch("1");
        aSN1ObjectIdentifier = pkcs_9.branch("23");
        crlTypes = aSN1ObjectIdentifier;
        x509Crl = aSN1ObjectIdentifier.branch("1");
        aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.1");
        id_ct = aSN1ObjectIdentifier;
        id_ct_authData = aSN1ObjectIdentifier.branch(BuildConfig.VERSION_NAME);
        aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.6");
        id_cti = aSN1ObjectIdentifier;
        id_cti_ets_proofOfOrigin = aSN1ObjectIdentifier.branch("1");
        aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.9.16.2");
        id_aa = aSN1ObjectIdentifier;
        id_aa_receiptRequest = aSN1ObjectIdentifier.branch("1");
        aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.2.840.113549.1.12");
        pkcs_12 = aSN1ObjectIdentifier;
        aSN1ObjectIdentifier = aSN1ObjectIdentifier.branch("10.1");
        bagtypes = aSN1ObjectIdentifier;
        keyBag = aSN1ObjectIdentifier.branch("1");
        aSN1ObjectIdentifier = pkcs_12.branch("1");
        pkcs_12PbeIds = aSN1ObjectIdentifier;
        pbeWithSHAAnd128BitRC4 = aSN1ObjectIdentifier.branch("1");
    }
}

...
public class DERExternal extends ASN1Primitive {
    ...
    boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        if (aSN1Primitive instanceof DERExternal) {
            ...
            if ((this.directReference == null || (dERExternal.directReference != null && dERExternal.directReference.equals(this.directReference))) && ((this.indirectReference == null || (dERExternal.indirectReference != null && dERExternal.indirectReference.equals(this.indirectReference))) && (this.dataValueDescriptor == null || (dERExternal.dataValueDescriptor != null && dERExternal.dataValueDescriptor.equals(this.dataValueDescriptor))))) {

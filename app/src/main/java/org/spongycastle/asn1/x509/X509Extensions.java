...
public class X509Extensions extends ASN1Object {
    ...
    public static X509Extensions getInstance(Object obj) {
        Object obj2 = obj;
        while (obj2 != null && !(obj2 instanceof X509Extensions)) {
            if (obj2 instanceof ASN1Sequence) {
                return new X509Extensions((ASN1Sequence) obj2);
            }
            if (obj2 instanceof Extensions) {
                return new X509Extensions((ASN1Sequence) ((Extensions) obj2).toASN1Primitive());
            }

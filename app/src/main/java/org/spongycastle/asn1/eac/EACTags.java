...
public class EACTags {
    ...
    public static int decodeTag(int i) {
        ...
        for (int i3 = 24; i3 >= 0; i3 -= 8) {
            int i4 = (i >> i3) & CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV;
            if (i4 != 0) {
                if (obj != null) {
    ...
    public static int getTagNo(int i) {
        for (int i2 = 24; i2 >= 0; i2 -= 8) {
            if (((CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV << i2) & i) != 0) {
                return ((CipherSuite.TLS_EMPTY_RENEGOTIATION_INFO_SCSV << i2) ^ -1) & i;
            }
        }
        return 0;
    }

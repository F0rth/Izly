...
public class LDAPStoreHelper {
    ...
    private static long lifeTime = WINGiTUtil.ONE_MINUTE;
        ...
        while (i < list.size()) {
            try {
                ...
                try {
                    ...
                    i++;
                    X509CertificatePair x509CertificatePair = new X509CertificatePair(new CertificatePair(X509CertificateStructure.getInstance(new ASN1InputStream(bArr).readObject()), X509CertificateStructure.getInstance(new ASN1InputStream(bArr2).readObject())));

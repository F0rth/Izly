...
class X509Util {
    ...
    static AlgorithmIdentifier getSigAlgID(DERObjectIdentifier dERObjectIdentifier, String str) {
        ...
        String toUpperCase = Strings.toUpperCase(str);
        return params.containsKey(toUpperCase) ? new AlgorithmIdentifier(dERObjectIdentifier, (ASN1Encodable) params.get(toUpperCase)) : new AlgorithmIdentifier(dERObjectIdentifier, new DERNull());
    }

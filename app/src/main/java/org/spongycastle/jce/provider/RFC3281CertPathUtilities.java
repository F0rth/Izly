                ...
                try {
                    ...
                    if (certStatus.getCertStatus() == 11 && !reasonsMask.isAllReasons()) {
                        try {
                            ...
                            annotatedException = new AnnotatedException("No valid CRL for distribution point found.", e222);
                        }
                    }
                    if (obj == null) {
        ...
        for (X509Certificate certificate : hashSet) {
            ...
            try {
                try {
                    ...
                    certPathBuilderResult2 = new ExtCertPathValidatorException("Certification path for public key certificate of attribute certificate could not be build.", e3);
